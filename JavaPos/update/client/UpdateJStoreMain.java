...
public class UpdateJStoreMain
{

	public UpdateJStoreMain()
	{
	...
	public static void main(String[] args)
	{
		...
		{
			/*
			 * if (args != null) { if (args.length >= 1) { GlobalVar.UpdateMode
			 * = args[0]; }
			 * 
			 * if (args.length >= 2) { RefushConfPath(args[1]); } }
			 * 
			 * if (GlobalVar.UpdateMode.equals("N")) return;
			 */
			RefushConfPath("./JStore.ConfigFile");
			new UpdatePosMain();
		}
		catch (Exception e)
		{
	...
	private static void RefushConfPath(String path)
	{
		...
		GlobalVar.PosIdConfig = path + "/MktID.ini";
