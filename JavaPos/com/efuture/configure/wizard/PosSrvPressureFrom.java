...
public class PosSrvPressureFrom
{
	...
	protected void createContents()
	{
		...
		shell.setText(Language.apply("PosServer压力测试"));
...
//		label.setText("服务器地址:");
		...
		label_1.setText(Language.apply("测试命令:"));
//		label_1.setText("测试命令:");
		...
		label_2.setText(Language.apply("线程数量:"));
//		label_2.setText("线程数量:");
		...
		label_3.setText(Language.apply("延时(毫秒):"));
...
//		label_4.setText("活动线程数量:");
		...
		label_4_1.setText(Language.apply("命令失败次数:"));
