...
public class BusinessPersonnelStatEvent 
{
	...
	public BusinessPersonnelStatEvent(BusinessPersonnelStatForm bpsf)
	{
		...
		//显示功能提示
		GlobalInfo.statusBar.setHelpMessage(Language.apply("按 '打印键' 打印营业员对账单"));
...
//				case GlobalVar.Validation://重百需要用此键做打印
				...
				case GlobalVar.Print:
					if(currow < 0)
                	{
                		new MessageBox(Language.apply("没有查询到营业员统计数据,不能打印!"), null, false);
                		break;
                	}
