...
import com.efuture.javaPos.UI.SyySaleStatEvent;
import com.efuture.javaPos.UI.DesignTouch.ControlBarForm;
import com.swtdesigner.SWTResourceManager;

public class SyySaleStatForm 
{
	...
	protected void createContents() 
	{
		...
		shell.setText(Language.apply("收银员销售统计"));
		...
		label.setText(Language.apply("销售笔数:"));
		...
		label_2.setText(Language.apply("销售金额:"));
		...
		label_3.setText(Language.apply("退货笔数:"));
		...
		label_3_1.setText(Language.apply("退货金额:"));
		...
		label_3_2.setText(Language.apply("红冲笔数:"));
		...
		label_3_1_1.setText(Language.apply("红冲金额:"));
		...
		label_3_2_1.setText(Language.apply("折扣金额:"));
		...
		label_3_1_1_1.setText(Language.apply("取消金额:"));
		...
		label_3_2_1_1.setText(Language.apply("损溢金额:"));
		...
		label_3_1_1_1_1.setText(Language.apply("找零金额:"));
		...
		newColumnTableColumn_2.setText(Language.apply("付款方式"));
		...
		newColumnTableColumn_3.setText(Language.apply("实收金额"));
		...
		label_3_2_1_1_1.setText(Language.apply("应收金额:"));
		...
		label_3_1_1_1_1_1.setText(Language.apply("实收金额:"));
		...
		label_1.setText(Language.apply("请输入查询日期"));
		...
		label_1_1.setText(Language.apply("格式为:YYYYMMDD[使用付款键切回输入日期框]"));
	}
