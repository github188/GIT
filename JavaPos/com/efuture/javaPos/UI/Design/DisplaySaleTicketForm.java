...
import com.efuture.javaPos.UI.DisplaySaleTicketEvent;
import com.efuture.javaPos.UI.DesignTouch.ControlBarForm;
import com.swtdesigner.SWTResourceManager;
public class DisplaySaleTicketForm 
{	
	...
	public DisplaySaleTicketForm(int type)
	{
		this.type = type;
		this.open(type);
	}
	
	public DisplaySaleTicketForm(String date,String code)
	{
		this.open(date,code);
	}
	...
	private void open(int type) 
	{
    	...
    	new DisplaySaleTicketEvent(this,null,null,false,type);
	...
	private void open(String date,String code)
	{
    	...
    	new DisplaySaleTicketEvent(this,date,code,true,StatusType.MN_XSCX);
	...
	protected void createContents() 
	{
		...
		shell.setText(Language.apply("显示小票信息"));
		...
		group.setText(Language.apply("收银机:"));

		final Label label = new Label(group, SWT.NONE);
		label.setFont(SWTResourceManager.getFont("宋体", 15, SWT.NONE));

		label.setBounds(10, 25, 60, 23);
		if (type ==  StatusType.MN_BACKSALE) 		label.setText(Language.apply("退货号"));
		else 		label.setText(Language.apply("小票号"));
		...
		label_1.setText(Language.apply("交易时间"));
		...
		label_3.setText(Language.apply("交易类型"));
		...
		label_4.setText(Language.apply("会员卡号"));
		...
		label_5.setText(Language.apply("授权卡号"));
		...
		label_10.setText(Language.apply("损溢金额"));
		...
		label_11.setText(Language.apply("扣回金额"));
