...
import com.efuture.javaPos.UI.AliSaleTicketListEvent;
import com.efuture.javaPos.UI.DesignTouch.ControlBarForm;
import com.swtdesigner.SWTResourceManager;

public class AliSaleTicketListForm 
{
	...
	public void open() 
	{
		...
		new AliSaleTicketListEvent(this); 
	...
	protected void createContents() 
	{
		...
		tabTickList.setBounds(3, 70, 739, 402);
		...
		final TableColumn newColumnTableColumn_10 = new TableColumn(tabTickList, SWT.NONE);
		newColumnTableColumn_10.setWidth(286);
		newColumnTableColumn_10.setText(Language.apply("商户订单号"));
...
//		newColumnTableColumn_5.setText(Language.apply("折扣额"));
		...
		label_2.setText(Language.apply("收银员号"));
...
//		cmbDjlb.setBounds(490, 25, 107, 28);
		...
		label_2_1_1.setBounds(435, 30, 159, 20);
