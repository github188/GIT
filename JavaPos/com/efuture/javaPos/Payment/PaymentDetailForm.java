...
public class PaymentDetailForm
{
    ...
    public void open(PaymentDetail pay,SaleBS sale,boolean isneedaccnt,boolean isneedidno)
    {
        ...
        new PaymentDetailEvent(this,pay,sale,isneedaccnt,isneedidno);
    ...
    public void open(PaymentDetail pay,SaleBS sale)
    {
