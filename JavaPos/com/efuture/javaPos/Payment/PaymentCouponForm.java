...
public class PaymentCouponForm 
{
	...
	public PaymentCouponForm()
	{
	
	}
	
	public void open(PaymentCoupon pay,SaleBS sale) 
	{
		...
		PaymentCouponEvent ev = new PaymentCouponEvent(this,pay,sale);
