...
public class PaymentDzqForm 
{
	...
	public PaymentDzqForm()
	{
	
	}
	
	public void open(PaymentDzq pay,SaleBS sale) 
	{
		...
		PaymentDzqEvent ev = new PaymentDzqEvent(this,pay,sale);
	...
	protected void createContents() 
	{
		...
		newColumnTableColumn_2.setText(Language.apply("券种名称"));
