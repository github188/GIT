...
public class PaymentSerialMzkForm
{
    ...
    public void open(PaymentSerialMzk pay,SaleBS sale, boolean isallowinputpaymoney)
    {
        ...
        new PaymentSerialMzkEvent(this,pay,sale,isallowinputpaymoney);
    ...
    public void open(PaymentSerialMzk pay,SaleBS sale)
    {
    	open(pay,sale,true);
    }
