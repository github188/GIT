...
public class PaymentCouponEvent
{
	...
	public PaymentCoupon payObj = null;
	public int[] currentPoint = new int[] { 0, 0 };
	public NewKeyListener keyNewEditor = null;
	public Label account = null;

	public PaymentCouponEvent(PaymentCouponForm pff, PaymentCoupon pay, SaleBS sale)
	{
	...
	public void findLocation()
	{
		...
		newEditor.setText(payObj.getDefaultMoney());
		newEditor.selectAll();
