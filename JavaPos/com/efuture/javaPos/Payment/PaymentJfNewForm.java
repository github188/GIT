...
public class PaymentJfNewForm 
{
	...
	public PaymentJfNewForm()
	{
	
	}
	
	public void open(PaymentJfNew pay,SaleBS sale) 
	{
        ...
        PaymentJfNewEvent ev = new PaymentJfNewEvent(this,pay,sale);
	...
	protected void createContents() 
	{
		...
		shell.setText(Language.apply("积分付款界面"));
