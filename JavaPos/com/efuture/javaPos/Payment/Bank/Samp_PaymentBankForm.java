...
public class Samp_PaymentBankForm implements Interface_PaymentBankForm
{
    ...
    public boolean open(PaymentBank pay,int type)
    {
        ...
        new Samp_PaymentBankEvent(this,pay,type);
    ...
    public boolean open(int type)
    {
        ...
        new Samp_PaymentBankEvent(this,type);
    ...
    private void createSShell()
    {
        ...
        formData_2.bottom = new FormAttachment(0, 225);
        formData_2.top = new FormAttachment(0, 205);
        lblMoney.setLayoutData(formData_2);
        lblMoney.setText("交易金额");
        lblMoney.setFont(SWTResourceManager.getFont("宋体", 15, SWT.NONE));
        txtStatus = new StyledText(sShell, SWT.NONE);
        ...
        formData_1_1_2.top = new FormAttachment(txtAuthno, 0, SWT.TOP);
