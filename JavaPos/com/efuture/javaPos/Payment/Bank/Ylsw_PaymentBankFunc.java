...
public class Ylsw_PaymentBankFunc extends PaymentBankFunc
{
    ...
    public boolean XYKNeedPrintDoc()
    {
        ...
        // 消费，消费撤销，隔日退货，重打签购单
        if ((type == PaymentBank.XYKJZ) || (type == PaymentBank.XYKXF) || (type == PaymentBank.XYKCX) || (type == PaymentBank.XYKTH) || (type == PaymentBank.XYKCD))
        {
            return true;
        }
        else
