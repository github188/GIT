...
public class Njys_PaymentBankFunc extends PaymentBankFunc{
	 static{
	 ...
	 public native String creditTransABC(String input);
	                              ...
	                              String oldauthno, String olddate, Vector memo)
	    {
	        try
	        {
	            ...
	            String request = null;
	            if ((request = creditTransABC(line)) == null)
                {
	                                      ...
	                                      String olddate, Vector memo)
	    {
	        try
	        {
	            ...
	            line = syjh+syyh+type1+jestr+ysyjh;
	    ...
	    public boolean XYKReadResult1(String result,int type)
	    {
	        try
	        {
	            ...
	            bld.trace   = Long.parseLong(Convert.newSubString(line, 40, 52));
	            bld.bankinfo= Convert.newSubString(line, 52);
