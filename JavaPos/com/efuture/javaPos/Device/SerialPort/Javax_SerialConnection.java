 ...
 */
public class Javax_SerialConnection implements SerialPortEventListener,
                                         CommPortOwnershipListener
{
    private Javax_SerialParameters parameters;
    private OutputStream os;
    private InputStream is;
    private CommPortIdentifier portId;
    private SerialPort sPort;
    private boolean open;
    public SerialInputEvent inputevent = null;
     ...
     */
    public Javax_SerialConnection(Javax_SerialParameters parameters)
    {
    ...
    public void openConnection() throws SerialConnectionException
    {
        ...
        {
            throw new SerialConnectionException(parameters.getPortName()+":"+e.getMessage());
        }
        ...
        try
        {
            sPort = (SerialPort) portId.open("Serial" +
                                             parameters.getPortName(), 30000);
        }
        catch (PortInUseException e)
        {
            throw new SerialConnectionException(parameters.getPortName()+" Opne Error:"+e.getMessage());
        }
