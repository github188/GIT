...
/*
 * @(#)SerialParameters.java	1.9 00/05/04 SMI
 * 
 ...
 */
public class Javax_SerialParameters {
     ...
     */
    public Javax_SerialParameters(String portName, int baudRate, int flowControlIn, 
	...
	if (parity.toLowerCase().equals("none")) {
