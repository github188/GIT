                                         ...
                                         CommPortOwnershipListener
{
    ...
    public void openConnection() throws SerialConnectionException
    {
        ...
        try
        {
        	...
        	while(portList != null)
        	{
        		...
        		else
        		{
        			sb.append(p.getName());
        			sb.append("\n");
        			if (p.getName().equals(parameters.getPortName()))
        			{
        				ok = true;
        				break;
        			}
        	...
        	if (!ok)
        	{
        		throw new SerialConnectionException(sb.toString());
        	}
        ...
        {
            throw new SerialConnectionException(parameters.getPortName()+" Open Error:"+e.getMessage());
        }
