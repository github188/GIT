...
implements ActionListener, Printable
{
    ...
    public PrintTest()
    {
        ...
        this.setBounds((int)((1024 - 800) / 2), (int)((768 - 600) / 2), 800, 600);
        initLayout();
    }
	...
	{
    	g2.setFont(new Font("宋体",0,9));
        Font f = new Font("宋体",0,9);//area.getFont();
    ...
    private void printTextAction()
    {
        ...
        if (printStr != null && printStr.length() > 0)
        {
            ...
            System.out.println(pageFormat.getWidth() * 1.0/72.0 * 25400 / 1000);
            System.out.println(pageFormat.getHeight() * 1.0/72.0 * 25400 / 1000);
            System.out.println(pageFormat.getImageableWidth() * 1.0/72.0 * 25400 / 1000);
            System.out.println(pageFormat.getImageableHeight() * 1.0/72.0 * 25400 / 1000);
            System.out.println(pageFormat.getImageableX() * 1.0/72.0 * 25400 / 1000);
            System.out.println(pageFormat.getImageableY() * 1.0/72.0 * 25400 / 1000);
            
            Paper p=new Paper();
            p.setImageableArea(0,0, 215, 25);
            p.setSize(215,254);
...
*/            
    ...
    private void printText2Action()
    {
        ...
        if (printStr != null && printStr.length() > 0)
        {
            ...
            printService = javax.print.ServiceUI.printDialog(null, 0, 0, PrintServiceLookup.lookupPrintServices(null,null), printService, null,pras);
            
            DocPrintJob job = printService.createPrintJob();
            job.getAttributes();
            
            pras.add(new javax.print.attribute.standard.MediaPrintableArea(0,0,76,297,MediaPrintableArea.MM));
