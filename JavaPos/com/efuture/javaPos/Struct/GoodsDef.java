...
// 商品基础资料定义
public class GoodsDef implements Cloneable, Serializable
{
	private static final long serialVersionUID = 1L;

	public static String[] ref = { "barcode", "gz", "code", "uid", "type", "name", "catid", "ppcode", "unit", "specinfo", "bzhl", "lsj", "hyj", "hyjzkfd", "pfj", "pfjzkfd", "xxtax", "xjjg", "jgjd", "minplsl", "isuid", "isbatch", "issqkzk", "isvipzk", "iszs", "isdzc", "ispj", "iszt", "maxzkl", "ischgjg", "maxzke", "fxm", "managemode", "memo", "str1", "str2", "str3", "str4", "str5", "num1", "num2", "num3", "num4", "num5", "attr01", "attr02", "attr03", "attr04", "attr05", "attr06", "attr07", "attr08", "isxh", "kcsl", "popdjbh", "poptype", "poplsj", "pophyj", "poppfj", "poplsjzkl", "pophyjzkl", "poppfjzkl", "poplsjzkfd", "pophyjzkfd", "poppfjzkfd", "pophymaxsl", "hypopdjbh", "hypophyj", "hypophyrate", "hypopzkfd", "num6" };

	public static String[] refLocal = { "barcode", "gz", "code", "uid", "type", "name", "catid", "ppcode", "unit", "specinfo", "bzhl", "lsj", "hyj", "hyjzkfd", "pfj", "pfjzkfd", "xxtax", "xjjg", "jgjd", "minplsl", "isuid", "isbatch", "issqkzk", "isvipzk", "iszs", "isdzc", "ispj", "iszt", "maxzkl", "ischgjg", "maxzke", "fxm", "managemode", "memo", "str1", "str2", "str3", "str4", "str5", "num1", "num2", "num3", "num4", "num5", "attr01", "attr02", "attr03", "attr04", "attr05", "attr06", "attr07", "attr08", "num6" };
	...
	public char type; // 编码类型(P-配件商品/Z-赠品/T-特卖/1-单品码/6-母商品/7-服务费/8-以旧换新/9-打包商品/A-一品多原印/B-一品多包装单位/C-子商品)
	...
	public String attr08; // 商品属性8 买券类型，兑换比例
	...
	public double pophymaxsl; // 会员限量时最大可享受数量

	public String hypopdjbh; // U51会员促销单会员单据编号
	public double hypophyj;// U51会员促销单会员价
	public double hypophyrate;// U51会员促销单会员折扣率
	public double hypopzkfd;// U51会员促销单会员折扣分担

	// 暂存数据
	public String inputbarcode; // 输入时的原始编码
	public double infonum1; // 优惠促销限量
	public double dblMaxYhSl; // 最大优惠数量（普通分期促销限量）

	// 辅助数据
	public String couponrule; // 商品用券信息
