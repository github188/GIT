...
import com.efuture.javaPos.Device.SerialPort.Javax_ParallelConnection;
import com.efuture.javaPos.Device.SerialPort.ParallelConnectionException;
import com.efuture.javaPos.Global.Language;

import device.DeviceInfo;

public class ParallelJavax_Printer implements Interface_Printer
{
	protected Javax_ParallelConnection  port = null;
    ...
    public boolean open()
    {
        ...
        {    	
        	...
        	port = new Javax_ParallelConnection (s[0]);
	...
	{
		return Language.apply("JAVAX并口打印机");
	}
