...
public class Cbbh_PaymentCouponNewEvent
{
                ...
                case GlobalVar.Validation:
                	...
                	if (e.widget == newEditor)
                	{
                		...
                		for(TableItem item : table.getItems())
                		{
                			...
                			//if(tEditor.getItem() == item)
                			//{
                			//	Text te = (Text) tEditor.getEditor();
                			//	text = te.getText();
                			//}
    ...
    public boolean setPayment(String text)
    {
    	StringBuffer buff = new StringBuffer();
    	if (!payObj.alreadyAddSalePay)
    		return payObj.CreateNewjPayment(currentPoint[0],Convert.toDouble(text.trim()),buff);
    	else
    		return true;
    }
