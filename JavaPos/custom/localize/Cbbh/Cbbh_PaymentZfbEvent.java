...
public class Cbbh_PaymentZfbEvent
{
    ...
    public Cbbh_PaymentZfb payObj = null;
    public boolean ShellIsDisposed = false;
    
    public Cbbh_PaymentZfbEvent(Cbbh_PaymentZfbForm form, Cbbh_PaymentZfb pay, SaleBS sale)
    {
        this.saleBS = sale;
        this.payObj = pay;
    ...
    public void recycle()
    {
    	Cbbh_PaymentZfb.recycleStatus = !Cbbh_PaymentZfb.recycleStatus;
