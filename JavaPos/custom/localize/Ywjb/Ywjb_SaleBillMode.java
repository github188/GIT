...
public class Ywjb_SaleBillMode extends Bcrm_SaleBillMode
{
    ...
    protected String extendCase(PrintTemplateItem item, int index)
    {
        ...
        switch (Integer.parseInt(item.code))
        {
            ...
            case SBM_payno: //付款方式帐号
                ...
                if (((SalePayDef) salepay.elementAt(index)).paycode.equals("0400"))
                {
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                for (i = 0; i < originalsalepay.size(); i++)
                {
                            ...
                            ((type == 2) && (CreatePayment.getDefault().isPaymentFjk(mode.code))))
                    {
                        ...
                        if (((pay.str5 != null) && pay.str5.equals("Y")) || (pay.kye == 0))
                        {
                            line1 = "(卡回收)";
                        }
                        ...
                        System.out.println("print  " + pay.kye);
                        Printer.getDefault()
