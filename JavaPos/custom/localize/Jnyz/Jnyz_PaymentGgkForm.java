...
public class Jnyz_PaymentGgkForm
{
	public Text PwdTxt;
    ...
    public Jnyz_PaymentGgk pay = null;
    
    public void open(Jnyz_PaymentGgk pay,SaleBS sale)
    {
        ...
        Jnyz_PaymentGgkEvent ev = new Jnyz_PaymentGgkEvent(this,pay,sale);
