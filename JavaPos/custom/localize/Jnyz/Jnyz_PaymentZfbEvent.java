...
public class Jnyz_PaymentZfbEvent
{
    ...
    public Jnyz_PaymentZfb payObj = null;
    public boolean ShellIsDisposed = false;
    
    public Jnyz_PaymentZfbEvent(Jnyz_PaymentZfbForm form, Jnyz_PaymentZfb pay, SaleBS sale)
    {
        this.saleBS = sale;
        this.payObj = pay;
    ...
    public void recycle()
    {
    	Jnyz_PaymentZfb.recycleStatus = !Jnyz_PaymentZfb.recycleStatus;
