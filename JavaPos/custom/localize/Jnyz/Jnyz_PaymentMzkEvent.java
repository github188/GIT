...
public class Jnyz_PaymentMzkEvent
{
    ...
    public Jnyz_PaymentMzk payObj = null;
    public boolean ShellIsDisposed = false;
    
    public Jnyz_PaymentMzkEvent(Jnyz_PaymentMzkForm form, Jnyz_PaymentMzk pay, SaleBS sale)
    {
        this.saleBS = sale;
        this.payObj = pay;
