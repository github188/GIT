...
public class Jnyz_PaymentZfbForm
{
	public Text PwdTxt;
    ...
    public Jnyz_PaymentZfb pay = null;
    
    public void open(Jnyz_PaymentZfb pay,SaleBS sale)
    {
        ...
        Jnyz_PaymentZfbEvent ev = new Jnyz_PaymentZfbEvent(this,pay,sale);
