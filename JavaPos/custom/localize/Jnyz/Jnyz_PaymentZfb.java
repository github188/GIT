...
public class Jnyz_PaymentZfb extends Bcrm_PaymentMzk {
	...
	public SalePayDef inputPay(String money) {
		try {
			...
			// 打开明细输入窗口
			new Jnyz_PaymentZfbForm().open(this, saleBS);
...
//						sbmsg.append("支付宝支付金额："+salepay.ybje+"元\n");
	...
	public HashMap readZfbFile() {
		...
		String configName = GlobalVar.ConfigPath + "//JnyzZfb.ini";
		String line = null;
		Map map = new HashMap();
	...
	public void specialDeal(Jnyz_PaymentZfbEvent event) {
	}

	public void setMoneyVisible(Jnyz_PaymentZfbEvent paymentMzkEvent) {

	}

	public void setPwdAndYe(Jnyz_PaymentZfbEvent event, KeyEvent e) {
		if (!SellType.ISSALE(saleBS.saletype)) {
			if (!flag) {
				// 输入金额
				if (e != null)
	...
	public void doAfterFail(Jnyz_PaymentZfbEvent zfbEvent) {
