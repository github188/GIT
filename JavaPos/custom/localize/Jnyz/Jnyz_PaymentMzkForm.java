...
public class Jnyz_PaymentMzkForm
{
	public Text PwdTxt;
    ...
    public Jnyz_PaymentMzk pay = null;
    
    public void open(Jnyz_PaymentMzk pay,SaleBS sale)
    {
        ...
        Jnyz_PaymentMzkEvent ev = new Jnyz_PaymentMzkEvent(this,pay,sale);
