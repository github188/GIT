...
public class Jnyz_PaymentGgkEvent
{
    ...
    public Jnyz_PaymentGgk payObj = null;
    public boolean ShellIsDisposed = false;
    
    public Jnyz_PaymentGgkEvent(Jnyz_PaymentGgkForm form, Jnyz_PaymentGgk pay, SaleBS sale)
    {
        this.saleBS = sale;
        this.payObj = pay;
    ...
    public void recycle()
    {
    	Jnyz_PaymentMzk.recycleStatus = !Jnyz_PaymentMzk.recycleStatus;
    	...
    	else if (txt.equals(pwdTxt))
    	{
    		...
    		if (payObj.compareInputPasswd(txt.getText()))
    		{
    			...
    			else
    			{
		    		...
		    		{
		    			moneyTxt.setText(ManipulatePrecision.doubleToString(syje));
		    		}
    			}
