...
public class Jnyz_PaymentMzk extends Bcrm_PaymentMzk{
...
//		根据不同键盘驱动解析磁道
	...
	public SalePayDef inputPay(String money)
	{
		try
		{
			...
			// 打开明细输入窗口
			new Jnyz_PaymentMzkForm().open(this,saleBS);
			
			//双屏显示卡余额
			saleBS.sendSecMonitor("MzkYe",new String[]{salepay.payno,ManipulatePrecision.doubleToString(salepay.kye-salepay.je)},-1);
...
//	密码输入次数限制验证
	...
	public void specialDeal (Jnyz_PaymentMzkEvent event)
	{
	}
	
	public void setMoneyVisible(Jnyz_PaymentMzkEvent paymentMzkEvent)
	{
	}
	
	public void setPwdAndYe (Jnyz_PaymentMzkEvent event, KeyEvent e)
	{
    	if (isPasswdInput())
    	{
    		// 显示密码
	...
	public void doAfterFail(Jnyz_PaymentMzkEvent mzkEvent)
	{
