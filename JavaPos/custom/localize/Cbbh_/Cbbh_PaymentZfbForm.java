...
public class Cbbh_PaymentZfbForm
{
	public Text PwdTxt;
    ...
    public Cbbh_PaymentZfb pay = null;
    
    public void open(Cbbh_PaymentZfb pay,SaleBS sale)
    {
        ...
        Cbbh_PaymentZfbEvent ev = new Cbbh_PaymentZfbEvent(this,pay,sale);
