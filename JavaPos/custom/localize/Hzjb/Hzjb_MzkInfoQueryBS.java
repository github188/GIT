...
public class Hzjb_MzkInfoQueryBS extends MzkInfoQueryBS
{
	public void QueryMzkInfo(PaymentMzk pay)
	{
		//如果pay为null,则生成默认面值卡对象 
		if(pay == null)
			pay = new Hzjb_PaymentMzk();
		
		if(pay.getClass()==Hzjb_PaymentMzk.class)
		{
			QueryHzjbMzkInfo(pay);
		}
		else if(pay.getClass()==Hzjb_JniICPaymentMzk.class)
		{
			QueryHlMzkInfo(pay);
		}
		else
