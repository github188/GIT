...
public class Hzjb_PaymentFjkPaper extends PaymentFjkPaper {
	public Hzjb_PaymentFjkPaper()
	{
		super();
	}
	
	public Hzjb_PaymentFjkPaper(PayModeDef mode, SaleBS sale)
	{
		super(mode,sale);
	...
	public Hzjb_PaymentFjkPaper(SalePayDef pay,SaleHeadDef head)
	{
		super(pay,head);
	}
	...
	public boolean sendMzkSale(MzkRequestDef req, MzkResultDef ret)
	{
		...
		if (paymode.code.equals("0520"))
		{
			...
			done = DataService.getDefault().sendFjkSale(req,ret);
		}
		else
		{
