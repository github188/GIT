...
public class Hzjb_PaymentMzk extends PaymentMzk
{
    public Hzjb_PaymentMzk()
    {
        super();
    }

    public Hzjb_PaymentMzk(PayModeDef mode, SaleBS sale)
    {
        super(mode, sale);
    }

    public Hzjb_PaymentMzk(SalePayDef pay, SaleHeadDef head)
    {
        super(pay, head);
    }
