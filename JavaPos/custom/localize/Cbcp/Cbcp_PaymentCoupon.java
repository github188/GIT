...
public class Cbcp_PaymentCoupon extends PaymentCoupon
{
	protected String autoTrack1 = null;
	protected String autoTrack2 = null;
	protected String autoTrack3 = null;

	public Cbcp_PaymentCoupon()
	{
	}

	public Cbcp_PaymentCoupon(PayModeDef mode, SaleBS sale)
	{
		initPayment(mode, sale);
	}

	public Cbcp_PaymentCoupon(SalePayDef pay, SaleHeadDef head)
	{
	...
	public boolean CreateNewjPayment(int index, double money, StringBuffer bufferStr)
	{
		try
		{
			...
			Cbcp_PaymentCoupon cpf = new Cbcp_PaymentCoupon(paymode, saleBS);
