...
public class Cbcp_DataService extends Bcrm_DataService
{
	...
	public boolean findWCCRules(String billno,Vector rules)
	{
		...
		{
            if (!((Cbcp_NetService)NetService.getDefault()).findWCCRules(billno, rules)) return false;			
		}
		else
		{
			if (!((Cbcp_AccessBaseDB)AccessBaseDB.getDefault()).findWCCRules(billno, rules)) return false;
		}
