...
public class Cbcp_PaymentZfbForm
{
	public Text PwdTxt;
    ...
    public Cbcp_PaymentZfb pay = null;
    
    public void open(Cbcp_PaymentZfb pay,SaleBS sale)
    {
        ...
        Cbcp_PaymentZfbEvent ev = new Cbcp_PaymentZfbEvent(this,pay,sale);
