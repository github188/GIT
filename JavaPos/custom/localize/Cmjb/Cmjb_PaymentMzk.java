...
public class Cmjb_PaymentMzk extends PaymentMzk
{
    public Cmjb_PaymentMzk()
    {
        super();
    }

    public Cmjb_PaymentMzk(PayModeDef mode, SaleBS sale)
    {
        super(mode, sale);
    }

    public Cmjb_PaymentMzk(SalePayDef pay, SaleHeadDef head)
    {
        super(pay, head);
    }
