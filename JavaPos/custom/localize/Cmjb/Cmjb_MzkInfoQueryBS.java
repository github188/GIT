...
public class Cmjb_MzkInfoQueryBS extends MzkInfoQueryBS
{
	public void QueryMzkInfo(PaymentMzk pay)
	{
		//如果pay为null,则生成默认面值卡对象 
		if(pay == null)
			pay = new Cmjb_PaymentMzk();
		
		if(pay.getClass()==Cmjb_PaymentMzk.class)
		{
			QueryHzjbMzkInfo(pay);
		}
		else if(pay.getClass()==Cmjb_JniICPaymentMzk.class)
		{
			QueryHlMzkInfo(pay);
		}
		else
		{
			 new MessageBox("不被支持的查询业务");
			 return;
		}
	}

	public void QueryHlMzkInfo(PaymentMzk mzk)
	{
		...
		try
        {
            ...
            info.append("    卡类型: " + Convert.appendStringSize("", mzk.mzkret.cardpwd, 1, 20, 20, 0) + "\n");
            info.append("    持卡人: " + Convert.appendStringSize("", mzk.mzkret.cardname, 1, 20, 20, 0) + "\n");  
            info.append("    卡功能: " + Convert.appendStringSize("", mzk.mzkret.func, 1, 20, 20, 0) + "\n"); 
            info.append("    余  额: " + Convert.appendStringSize("", ManipulatePrecision.doubleToString(mzk.mzkret.ye), 1, 20, 20, 0) + "\n");           
            info.append("    工本费: " + Convert.appendStringSize("", ManipulatePrecision.doubleToString(mzk.mzkret.num1), 1, 20, 20, 0) + "\n");
            info.append("待同步金额: " + Convert.appendStringSize("", ManipulatePrecision.doubleToString(mzk.mzkret.num2), 1, 20, 20, 0) + "\n");
           // info.append("    有效期: " + Convert.appendStringSize("", mzk.mzkret.str1, 1, 20, 20, 0) + "\n");   
            ...
            info.append("  联网校验: " + Convert.appendStringSize("", mzk.mzkret.str3, 1, 20, 20, 0) + "\n");
         //   info.append("  当前积分: " + Convert.appendStringSize("", ManipulatePrecision.doubleToString(mzk.mzkret.num3), 1, 20, 20, 0) + "\n");
	...
	public void QueryHzjbMzkInfo(PaymentMzk mzk)
    {
        String track1;
        String track2;
        String track3;
        ...
        // 创建面值卡付款对象
        //Hzjb_PaymentMzk mzk = new Hzjb_PaymentMzk();
