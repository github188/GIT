...
public class Cmjb_JniICPaymentMzk extends PaymentMzk
{
	public Cmjb_JniICPaymentMzk()
	{
		super();
	}

	public Cmjb_JniICPaymentMzk(PayModeDef mode, SaleBS sale)
	{
		initPayment(mode, sale);
	}

	public Cmjb_JniICPaymentMzk(SalePayDef pay, SaleHeadDef head)
	{
