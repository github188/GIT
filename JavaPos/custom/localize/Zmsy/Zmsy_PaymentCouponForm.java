...
public class Zmsy_PaymentCouponForm 
{
	...
	public Zmsy_PaymentCouponForm()
	{
	
	}
	
	public void open(Zmsy_PaymentCoupon pay,SaleBS sale) 
	{
		...
		Zmsy_PaymentCouponEvent ev = new Zmsy_PaymentCouponEvent(this,pay,sale);
