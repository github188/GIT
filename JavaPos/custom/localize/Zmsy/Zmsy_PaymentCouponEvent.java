...
public class Zmsy_PaymentCouponEvent
{
    ...
    public Zmsy_PaymentCoupon payObj = null;
    ...
    public Zmsy_PaymentCouponEvent(Zmsy_PaymentCouponForm pff, Zmsy_PaymentCoupon pay, SaleBS sale)
    {
