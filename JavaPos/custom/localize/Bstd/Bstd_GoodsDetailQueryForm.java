...
public class Bstd_GoodsDetailQueryForm 
{
	...
	public Bstd_GoodsDetailQueryForm(GoodsDef goods,Vector yhList)
	{
		this.open(goods,yhList);
	}
	
	public void open(GoodsDef goods,Vector yhList) 
	{
		final Display display = Display.getDefault();
		createContents();

		new Bstd_GoodsDetailQueryEvent(this,goods,yhList);
	...
	protected void createContents() 
	{
		...
		label_6_1_2_2_1_1_1.setText("vip折");
		...
		label_6_1_2_2_1_1_1_1.setText("多单位");
		...
		label_15.setText("会员分担");
		label_15.setBounds(5, 230, 79, 19);
		...
		label_16.setText("批发分担");
		label_16.setBounds(290, 230, 80, 20);
		...
		tabpop = new Table(shell, SWT.BORDER |SWT.FULL_SELECTION);
