...
public class Gbyw_PaymentLczc extends Payment
{
	public Gbyw_PaymentLczc()
	{

	}

	public Gbyw_PaymentLczc(PayModeDef mode, SaleBS sale)
	{
		initPayment(mode, sale);
	}

	// 该构造函数用于红冲小票时,通过小票付款明细创建对象
	public Gbyw_PaymentLczc(SalePayDef pay, SaleHeadDef head)
	{
