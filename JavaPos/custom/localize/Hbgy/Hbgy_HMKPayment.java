...
public class Hbgy_HMKPayment extends Payment
{

	public Hbgy_HMKPayment()
	{

	}

	public Hbgy_HMKPayment(PayModeDef mode, SaleBS sale)
	{
		initPayment(mode, sale);
	}

	// 该构造函数用于红冲小票时,通过小票付款明细创建对象
	public Hbgy_HMKPayment(SalePayDef pay, SaleHeadDef head)
	{
	...
	{
		if (salepay != null)
			new MessageBox("由于此单存在特殊折扣,无法撤销或删除，必须完成付款");
