...
public class Hbgy_PaymentCustJfSale extends PaymentCustJfSale
{
	private double allowchgje = 0.0;

	public Hbgy_PaymentCustJfSale()
	{
	}

	public Hbgy_PaymentCustJfSale(PayModeDef mode, SaleBS sale)
	{
		initPayment(mode, sale);
	}

	public Hbgy_PaymentCustJfSale(SalePayDef pay, SaleHeadDef head)
	{
	...
	public void specialDeal(PaymentMzkEvent event)
	{
		...
		{
			event.moneyTxt.setText(ManipulatePrecision.doubleToString(allowchgje));
