...
public class Hhdl_CouponDef implements Cloneable
{

	public static String[] ref = { "iscommon", "type", "cardno", "money", "rule", "memo" };

	public String iscommon; // 是否通收
	...
	// 辅助字段
	public double totalmoney; // 券累计金额
	public double minlimitmoney; // 用于计算最低限额

	public String goodsindex; // 此规则券一共是哪些商品可用
	public String allsaleindex; // 哪些商品都即可用全场又可用非全场
	public int maxmoneyindex; // 此规则券下最大金额的商品索引
