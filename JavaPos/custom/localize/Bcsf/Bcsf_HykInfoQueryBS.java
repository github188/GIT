...
public class Bcsf_HykInfoQueryBS extends HykInfoQueryBS
{
	protected void getHykDisplayInfo(CustomerDef cust, StringBuffer info)
	{
		if (cust.code.length() >= 10) 
		{
			info.append("卡    号: " + Convert.appendStringSize("", cust.code.substring(10), 1, 16, 16, 0) + "\n");
		}
		else
		{
