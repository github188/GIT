...
public class Nnmk_ExchangeCardEvent
{
	public Text oldcard;
	public Text newcard;
	Nnmk_ExchangeCardBS cardbs = null;
	public StyledText text;
	public Shell sShell;
	
	public Nnmk_ExchangeCardEvent(Nnmk_ExchangeCardForm form)
	{
        ...
        newcard.addKeyListener(key);
        
        cardbs = new Nnmk_ExchangeCardBS();
	}
