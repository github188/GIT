...
public class Nnmk_MzkInfoQueryBS extends MzkInfoQueryBS
{
	public void QueryFjkInfo()
	{
		...
		String[] title = { "卡号", "券名称", "截止时间", "余额"};
		int[] width = { 150, 120, 140, 100,};
		//new MutiSelectForm().open("卡数量:0" + "   总余额:" + ManipulatePrecision.doubleToString(0), title, width, null, false, 589, 319, 560, 192, false,false, -1, false, 0, 0, null, null, null, 302);
		new MutiSelectForm().open("卡数量:0" , title, width, null, false, 589, 319, 560, 192, false,false, -1, false, 0, 0, null, null, null, 310);
		//}
	...
	public void QueryMzkInfo(PaymentMzk pay)
	{
		 ...
		 */
		String[] title = { "卡号", "余额", "状态" };
		int[] width = { 260, 100, 170 };
		new MutiSelectForm().open("卡数量:0" + "   总余额:" + ManipulatePrecision.doubleToString(0), title, width, null, false, 589, 319, 560, 192, false,
									false, -1, false, 0, 0, null, null, null, 301);
		//}
	}
