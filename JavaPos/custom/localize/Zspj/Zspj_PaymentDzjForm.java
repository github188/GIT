...
public class Zspj_PaymentDzjForm
{
	public Text PwdTxt;
    ...
    public Zspj_PaymentDzj pay = null;
    
    public void open(Zspj_PaymentDzj pay,SaleBS sale)
    {
        ...
        Zspj_PaymentDzjEvent ev = new Zspj_PaymentDzjEvent(this,pay,sale);
