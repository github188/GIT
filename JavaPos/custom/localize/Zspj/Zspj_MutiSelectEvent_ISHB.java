...
public class Zspj_MutiSelectEvent_ISHB
{
    private Zspj_MutiSelectForm_ISHB form = null;
    ...
    private Zspj_MutiSelectBS_ISHB msbs = null;

	public Zspj_MutiSelectEvent_ISHB(final Zspj_MutiSelectForm_ISHB form, String help_txt, String[] title,int[] width, Vector content,boolean textInput,boolean manychoice,boolean modifyvalue,int rowindex,boolean specifyback,String[] title1,int[] width1,Vector content2,int funcID,boolean cannotchoice)
    {
        this.form = form;
        ...
        form.table.addMouseListener(new MouseAdapter()
        {
            ...
            {
            	if (Zspj_MutiSelectEvent_ISHB.this.textInput && form.table.getSelectionIndex() >= 0)
            	{
        ...
        msbs = (Zspj_MutiSelectBS_ISHB)CustomLocalize.getDefault().createMutiSelectBS();
