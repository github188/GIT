...
public class Zspj_PaymentHb extends PaymentCoupon {
...
//				new MessageBox("退货时不能使用" + paymode.name);
			...
			// 打开明细输入窗口
			new Zspj_PaymentHbForm().open(this, saleBS);
	...
	public void setPwdAndYe(Zspj_PaymentHbEvent event, KeyEvent e)
	{
		if (isPasswdInput())
		{
			// 显示密码
...
//					成功先写冲正文件
	...
	public void specialDeal(Zspj_PaymentHbEvent event)
	{
	}
	
	public void doAfterFail(Zspj_PaymentHbEvent mzkEvent)
	{
...
//			oid+pid+tid+yyyyMMddHHmmss
			...
			tradefirst.setOid(salehead.mkt);
			tradefirst.setOtype(2);
