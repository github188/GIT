...
public class Zspj_TaskExecute extends TaskExecute
{
		...
		try
		{
			...
			if (sql != null)
			{
				...
				try
				{
					...
					rs = sql.selectData("select * from SALEHEAD where fphm = " + rq[1] + " order by fphm"); //and (str3 <> 'Y'  or str3 = '' or str3 is null) 
					if (rs != null && rs.next())
					{
