...
public class Zspj_PaymentHbForm
{
	public Text PwdTxt;
    ...
    public Zspj_PaymentHb pay = null;
    
    public void open(Zspj_PaymentHb pay,SaleBS sale)
    {
        ...
        Zspj_PaymentHbEvent ev = new Zspj_PaymentHbEvent(this,pay,sale);
