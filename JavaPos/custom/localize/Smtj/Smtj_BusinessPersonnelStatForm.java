...
public class Smtj_BusinessPersonnelStatForm
{
	...
	public Smtj_BusinessPersonnelStatForm()
	{
		this.open();
	}
	...
	public void open() 
	{
		...
		new Smtj_BusinessPersonnelStatEvent(this);
	...
	protected void createContents() 
	{
		...
		newColumnTableColumn.setText("营业员号");
		...
		newColumnTableColumn_1.setText("销售金额");
		...
		newColumnTableColumn_2.setText("笔数");
		...
		newColumnTableColumn_6.setText("折扣金额");
		...
		newColumnTableColumn_3.setText("退货金额");
		...
		newColumnTableColumn_5.setText("折扣金额");
...
*/
		...
		cmbSyyh.select(0);
		cmbSyyh.setItems(new String[] {"当前款员", "所有款员"});
