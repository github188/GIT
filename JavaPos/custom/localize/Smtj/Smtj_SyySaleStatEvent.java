...
public class Smtj_SyySaleStatEvent
{
	...
	public Smtj_SyySaleStatEvent(Smtj_SyySaleStatForm sssf)
	{
		...
		//显示功能提示
		GlobalInfo.statusBar.setHelpMessage("按 '打印键' 打印该收银员汇总表");
    	...
    	try
		{
			switch(key)
			{
				...
				case GlobalVar.Print:
					...
					if(tabBaseInfo.getSelectionIndex() < 0)
                	{
                		new MessageBox("至少要选择一项收银员报表", null, false);
                		break;
                	}
