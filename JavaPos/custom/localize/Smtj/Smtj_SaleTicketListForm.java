...
public class Smtj_SaleTicketListForm
{
	...
	public Smtj_SaleTicketListForm()
	{
		this.open();
	}
	...
	public void open() 
	{
		...
		new Smtj_SaleTicketListEvent(this); 
	...
	protected void createContents() 
	{
		...
		newColumnTableColumn_4.setText("应收金额");
		...
		label_2_1.setText("类型");

		cmbDjlb = new Combo(group, SWT.READ_ONLY);
		cmbDjlb.select(0);
		cmbDjlb.setItems(new String[] {"全部交易", "销售小票", "退货小票", "红冲小票"});
		...
		lblmessge.setText("单据总数:0 应收合计:0.00 应缴合计:0.00" );	
	}
