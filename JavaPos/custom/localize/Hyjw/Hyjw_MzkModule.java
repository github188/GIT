...
public class Hyjw_MzkModule
{
	...
	public static Hyjw_MzkModule module = new Hyjw_MzkModule();

	public static Hyjw_MzkModule getDefault()
	{
		return module;
	}
	...
	public boolean sendScore(String djlb, double score)
	{
		String cmd = null;
