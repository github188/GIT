...
public class Hyjw_PaymentMzkEvent
{
	...
	public Hyjw_PaymentMzk payObj = null;

	public Hyjw_PaymentMzkEvent(Hyjw_PaymentMzkForm form, Hyjw_PaymentMzk pay, SaleBS sale)
	{
		this.saleBS = sale;
		this.payObj = pay;
	...
	public void keyReleased(KeyEvent e, int key)
	{
		...
		case GlobalVar.Enter:
			...
			{
				RetInfoDef retinfo = Hyjw_MzkModule.getDefault().cardQuery(true);
