...
public class Zsbh_PaymentHbEvent
{
    ...
    public Zsbh_PaymentHb payObj = null;
    public boolean ShellIsDisposed = false;
    
    public Zsbh_PaymentHbEvent(Zsbh_PaymentHbForm form, Zsbh_PaymentHb pay, SaleBS sale)
    {
        this.saleBS = sale;
        this.payObj = pay;
...
//            StatusInfo.setText(payObj.getDisplayStatusInfo());
    ...
    public void recycle()
    {
    	Zsbh_PaymentHb.recycleStatus = !Zsbh_PaymentHb.recycleStatus;
