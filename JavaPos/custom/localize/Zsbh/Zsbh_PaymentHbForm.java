...
public class Zsbh_PaymentHbForm
{
	public Text PwdTxt;
    ...
    public Zsbh_PaymentHb pay = null;
    
    public void open(Zsbh_PaymentHb pay,SaleBS sale)
    {
        ...
        Zsbh_PaymentHbEvent ev = new Zsbh_PaymentHbEvent(this,pay,sale);
    ...
    private void createSShell()
    {
        ...
        Acount.setText(Language.apply("请 刷 卡"));
        ...
        YeTips.setText(Language.apply("扫手机码"));
