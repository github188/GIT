...
public class Gzbh_RePrintTMQBS
{

	public Vector mzkInfo = new Vector();

	public Gzbh_RePrintTMQBS()
	{

	}
	
	public boolean initRePrintJFK(Table tabQueryMzkSell)
	{
		try
		{
			...
			result = netservice.rePrinttDzkInfo(record, "0031");
	...
	public void rePrintJfk(String[] info)
	{
		...
		Printer.getDefault().printLine_Normal("条码现金券结算单(补打)：");
