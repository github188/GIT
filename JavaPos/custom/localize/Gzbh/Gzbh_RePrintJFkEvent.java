...
public class Gzbh_RePrintJFkEvent
{

	private Table tabRePrintJFK = null;
	protected Shell shell = null;
	private Gzbh_RePrintJFkBS rpjfkbs = null;

	private int currow = 0;

	public Gzbh_RePrintJFkEvent(Gzbh_RePrintJFkForm rpjfkf)
	{
		tabRePrintJFK = rpjfkf.getTabRePrintJFK();
		shell = rpjfkf.getShell();
		rpjfkbs = new Gzbh_RePrintJFkBS();
