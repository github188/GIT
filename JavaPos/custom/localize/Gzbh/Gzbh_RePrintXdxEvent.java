...
public class Gzbh_RePrintXdxEvent
{

	private Table tabRePrintJFK = null;
	protected Shell shell = null;
	private Gzbh_RePrintXdxBS rpjfkbs = null;

	private int currow = 0;

	public Gzbh_RePrintXdxEvent(Gzbh_RePrintXdxForm rpjfkf)
	{
		tabRePrintJFK = rpjfkf.getTabRePrintJFK();
		shell = rpjfkf.getShell();
		rpjfkbs = new Gzbh_RePrintXdxBS();
		...
		try
		{
			...
			if (rpjfkbs.initRePrintXdx(tabRePrintJFK))
			{
				setSelection(0, true);
			}
		}
