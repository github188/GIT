...
public class Cctd_DisplaySaleTicketBS extends DisplaySaleTicketBS
{
	...
	protected boolean setSaleRedQuash()
	{
		...
		if (((Cctd_DataService) DataService.getDefault()).getHHback(ConfigClass.CashRegisterCode, buff))
		{
