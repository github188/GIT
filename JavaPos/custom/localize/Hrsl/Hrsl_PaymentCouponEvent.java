...
public class Hrsl_PaymentCouponEvent
{
    ...
    public Hrsl_PaymentCoupon payObj = null;
    public int[] currentPoint = new int[] { 0, 0 };
    public NewKeyListener keyNewEditor = null;
    public Label account = null;

    public Hrsl_PaymentCouponEvent(Hrsl_PaymentCouponForm pff, Hrsl_PaymentCoupon pay, SaleBS sale)
    {
