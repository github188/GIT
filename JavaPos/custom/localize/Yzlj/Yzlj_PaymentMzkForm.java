...
public class Yzlj_PaymentMzkForm
{
	public Text PwdTxt;
    ...
    public Yzlj_PaymentMzk pay = null;
    
    public void open(Yzlj_PaymentMzk pay,SaleBS sale)
    {
        ...
        Yzlj_PaymentMzkEvent ev = new Yzlj_PaymentMzkEvent(this,pay,sale);
