...
public class Yzlj_PaymentGgkEvent
{
    ...
    public Yzlj_PaymentGgk payObj = null;
    public boolean ShellIsDisposed = false;
    
    public Yzlj_PaymentGgkEvent(Yzlj_PaymentGgkForm form, Yzlj_PaymentGgk pay, SaleBS sale)
    {
        this.saleBS = sale;
        this.payObj = pay;
    ...
    public void recycle()
    {
    	PaymentMzk.recycleStatus = !PaymentMzk.recycleStatus;
