...
public class Yzlj_PaymentGgk extends PaymentMzk{
...
//		根据不同键盘驱动解析磁道
	...
	public SalePayDef inputPay(String money)
	{
		try
		{
			...
			// 打开明细输入窗口
			new Yzlj_PaymentGgkForm().open(this,saleBS);
...
//	密码输入次数限制验证
	...
	public void specialDeal (Yzlj_PaymentGgkEvent event)
	{
	}
	
	public void setMoneyVisible(Yzlj_PaymentGgkEvent paymentMzkEvent)
	{
	}
	
	public void setPwdAndYe (Yzlj_PaymentGgkEvent event, KeyEvent e)
	{
    	if (isPasswdInput())
    	{
    		// 显示密码
	...
	public void doAfterFail(Yzlj_PaymentGgkEvent mzkEvent)
	{
