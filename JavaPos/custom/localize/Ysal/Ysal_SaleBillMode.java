...
import custom.localize.Bjys.Bjys_PaymentBank;
import custom.localize.Cmls.Cmls_SaleBillMode;

public class Ysal_SaleBillMode extends Cmls_SaleBillMode
{
    ...
    private boolean isbjysprint = false;
    ...
    public void printBottom()
	{
    	...
    	if (getMktCode() != null && getMktCode().trim().equals("0005"))
    	{
	    	if (isbjysprint)
	    	{
	    		isbjysprint = false;
    ...
    public void printDetail(CalcRulePopDef crp)
    {
        ...
        printLine(" 小计:" +
                  Convert.appendStringSize("",
                                           ManipulatePrecision.doubleToString(xj),
                                           0, 10, 10) + "  折扣:" +
                  Convert.appendStringSize("",
                                           ManipulatePrecision.doubleToString(zk),
                                           0, 10, 10));
    ...
    public void printBill()
    {
    	...
    	if (mktcode != null && mktcode.trim().equals("0005"))
		{
    		for (int i = 0;i < GlobalInfo.sysPara.salebillnum ;i++)
    		{
    			if (i > 0) isbjysprint = true;
