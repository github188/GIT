...
public class MisposWd_PaymentBankFunc extends PaymentBankFunc
{
	...
	public String[] getFuncItem()
    {
		...
		func[7] = "[" + PaymentBank.XKQT5 + "]" + "电子现金支付";
		func[8] = "[" + PaymentBank.XKQT6 + "]" + "电子现金查余";
	...
	public boolean getFuncText(int type, String[] grpTextStr)
	{
		...
		switch (type)
		{
			...
			case PaymentBank.XKQT1://签购单重打上一笔
				...
				break;
			case PaymentBank.XKQT5://签购单重打上一笔
				grpTextStr[0] = null;
				grpTextStr[1] = null;
				grpTextStr[2] = null;
				grpTextStr[3] = null;
				grpTextStr[4] = "按回车键开始电子支付";
				break;
			case PaymentBank.XKQT6://签购单重打上一笔
				grpTextStr[0] = null;
				grpTextStr[1] = null;
				grpTextStr[2] = null;
				grpTextStr[3] = null;
				grpTextStr[4] = "按回车键开始电子余额查询";
				break;
		}
		...
		try
		{
            ...
            if (type == PaymentBank.XYKXF)
			{
				if ((memo != null && memo.size() > 0))
				{
					...
					contents.add(new String[] { "00", "正常支付" });
					contents.add(new String[] { "01", "电子现金支付" });
			    ...
			    if(allinpayApp!=null){
			    	...
			    	if(result.toString().trim().equals("0")){
				    	...
				    	if(bld.retcode.equals("00")){
				    		if ((TransType.equals("14") || TransType.equals("16") || TransType.equals("18") || TransType.equals("27")))
				    			return true;
	...
	//消费，撤销，退货需要判断唯一标示是否一致,这里交易类型标示是取的银行设置的值
