 ...
 *
 */
public class FrtNew_PaymentBankFunc extends PaymentBankFunc
{	
	public String[] getFuncItem()
	{
		...
		func[7] = "[" + PaymentBank.XKQT1 + "]" + "查询交易信息";
	...
	public boolean getFuncLabel(int type, String[] grpLabelStr)
	{
		...
		switch (type)
		{
			...
			case PaymentBank.XYKCD://重打上笔签购单
				...
				break;
			case PaymentBank.XKQT1://查询交易信息
				grpLabelStr[0] = null;
				grpLabelStr[1] = null;
				grpLabelStr[2] = null;
				grpLabelStr[3] = null;
				grpLabelStr[4] = "查询交易信息";
				break;
			case PaymentBank.XKQT2://提取交易信息
				grpLabelStr[0] = null;
				grpLabelStr[1] = null;
				grpLabelStr[2] = null;
				grpLabelStr[3] = null;
...
//          写入请求数据
	...
	public String XYKgetRequest(int type, double money, String track1, String track2, String track3, String oldseqno, String oldauthno, String olddate, Vector memo)
	{
		 ...
		 try
		 {
			 switch (type)
			 {
				...
				// 根据要求拼接传入串
				String flag = "^";
				line ="02"+flag+syjh+flag+mkt + flag + syyh+flag +mtype1+flag+ money + flag + oldseqno + "^^^"+oldauthno+flag+olddate+flag+track2+flag+flag;
				return line;
		 }
		 catch (Exception ex)
		 {
	...
	public String getErrorInfo(String retcode)
    {
        ...
        try
        {
            ...
            if (!PathFile.fileExist("C:\\ALLINPAY\\ALLINPAY\\wanshangcode.txt") ||
                    !rtf.loadFile("C:\\ALLINPAY\\ALLINPAY\\wanshangcode.txt"))
            {
                new MessageBox("找不到C:\\ALLINPAY\\ALLINPAY\\wanshangcode.txt", null, false);
