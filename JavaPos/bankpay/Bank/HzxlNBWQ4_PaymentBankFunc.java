 ...
 *
 */
public class HzxlNBWQ4_PaymentBankFunc extends PaymentBankFunc {
	...
	public boolean getFuncText(int type, String[] grpTextStr)
	{
		...
		switch (type)
		{
			...
			case PaymentBank.XKQT3://电子支付消费
				...
				grpTextStr[4] = null;
				break;
			case PaymentBank.XKQT4://电子支付余额查询
				grpTextStr[0] = null;
				grpTextStr[1] = null;
				grpTextStr[2] = null;
				grpTextStr[3] = null;
				grpTextStr[4] = "按回车键开始电子支付余额查询";
				break;
			default:
				return false;
		}
