...
//河北惠友，收银机号传入时，取门店号后三位+款机后三位
import com.efuture.javaPos.UI.Design.MutiSelectForm;

public class BjcsHbhy_PaymentBankFunc extends BjcsTjyt_PaymentBankFunc
{
	...
	public String[] getFuncItem()
    {
        ...
        func[6] = "[" + PaymentBank.XKQT1 + "]" + "按系统参考号打印";
	...
	public boolean XYKWriteRequest(int type, double money, String track1,String track2, String track3,String oldseqno, String oldauthno,String olddate, Vector memo)
	{
		try
		{
	        ...
	        // 取门店号后三位+款机后三位
	         String zdh = GlobalInfo.sysPara.mktcode.substring(GlobalInfo.sysPara.mktcode.trim().length()-3)+GlobalInfo.syjDef.syjh.substring(GlobalInfo.syjDef.syjh.trim().length()-3);
	         //	 根据不同的类型生成文本结构
	         switch (type)
	         {
	        		...
	        		if (choice == 1)
  					{
  						if (saleBS != null)
  		        		 {
  		        			 line 		= "B" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm +"||" + zdh + "|\0";
  		        		 }
  		        		 else
  		        		 {
  		        			 line 		= "B" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"|||" + zdh +"|\0";
  		        		 }
  					}
  					else 
  					{
  						if (saleBS != null)
  		        		 {
  		        			 line 		= "0" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm +"||" + zdh + "|\0";
  		        		 }
  		        		 else
  		        		 {
  		        			 line 		= "0" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"|||" + zdh +"|\0";
  		        		 }
  					}
	        	 ...
	        	 case PaymentBank.XYKCX:
	        		 if (saleBS != null)
	        		 {
	        			 line = "5" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm + "|" + oldseqno + "|" + zdh + "|\0";
	        		 }
	        		 else
	        		 {
	        			 line = "5" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"||" + oldseqno + "|" + zdh + "|\0";
	        		 }
	        	 ...
	        	 case PaymentBank.XYKTH:
	        		 if (saleBS != null)
	        		 {
	        			 line = "4" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm + "|" + oldseqno + "|" + zdh + "|\0";
	        		 }
	        		 else
	        		 {
	        			 line = "4" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"||" + oldseqno + "|" + zdh + "|\0";
	        		 }
	        	 break;
	        	 ...
	        	 case PaymentBank.XKQT1:
	        		 ...
	        		 line = "8||"+ GlobalInfo.syjStatus.syyh+"||" + oldseqno + "|" + zdh + "|\0";
	        	 break;
...
//	        		 line = "9||||| "+ GlobalInfo.syjDef.syjh + "|\0";
	        		 line = "9||" + GlobalInfo.posLogin.gh + "||| "+ zdh + "|\0";
//	        		 
	        	 break;	 
	         }
...
//	           }
	           if(result.length >= 13 && result[12] != null && !result[12].equals(""))
	           {
	        	   bld.ylzk = ManipulatePrecision.doubleConvert(Double.parseDouble(result[12]) / 100, 2, 1);
	           }
	 ...
	 public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
		{
			try
			{
	            ...
	            if(type == PaymentBank.XYKXF){
					...
					contents.add(new String[] { "2", "联合促销消费" });
						
					choice = new MutiSelectForm().open("请选择交易类型", title, width, contents, true);
