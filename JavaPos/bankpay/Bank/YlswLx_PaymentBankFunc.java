...
/**
*鲁巷购物广场，复制中亚糖酒(无界面模式)，修改很小
*/
public class YlswLx_PaymentBankFunc extends PaymentBankFunc
{	
	...
	public String[] getFuncItem()
	{
		...
		func[7] = "[" + PaymentBank.XKQT2 + "]" + "重打签购单";
	...
	public boolean getFuncLabel(int type, String[] grpLabelStr)
	{
		...
		switch (type)
		{
			...
			case PaymentBank.XYKCD://重打上笔签购单
				...
				break;
			case PaymentBank.XKQT2://重打上笔签购单
				grpLabelStr[0] = "原流水号";
				grpLabelStr[1] = null;
				grpLabelStr[2] = null;
				grpLabelStr[3] = null;
...
//			 返回码
			...
			{
				bld.retmsg = "交易失败";
				bld.retmsg = newLine.substring(44,len -64).trim();
				errmsg = bld.retmsg;
				return false;
			}
			else
