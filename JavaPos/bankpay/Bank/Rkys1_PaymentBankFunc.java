...
public class Rkys1_PaymentBankFunc extends PaymentBankFunc
{
	...
	public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
	{
		try
		{
            ...
            {
                // 调用接口模块
                if (PathFile.fileExist("C:\\JavaPos\\javaposbank1.exe"))
                {
                	CommonMethod.waitForExec("C:\\JavaPos\\javaposbank1.exe RKYS");
                }
                else
                {
                    new MessageBox("找不到金卡工程模块 javaposbank1.exe");
                    XYKSetError("XX","找不到金卡工程模块 javaposbank1.exe");
                    return false;
                }
	...
	{
		if (bld.retcode.trim().equals("1") || bld.retcode.trim().equals("3"))
		{
			bld.retbz = 'Y';
	...
	public boolean XYKReadResult()
	{
		...
		try
        {
            ...
            {
            	bld.cardno 		= result[1].substring(0,19);
            	bld.je	   		= ManipulatePrecision.doubleConvert(ManipulatePrecision.div(Double.parseDouble(result[1].substring(19,31) ),100),2,1);
