...
/**
 * 秋林国际购物中心，我们界面读取轨道信息并增加分销付款方式
 * @author Administrator
 *
 */
public class HzxlQlgjFq_PaymentBankFunc extends PaymentBankFunc
{
	  ...
	  public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
	  {
		  try
	      {
			  if ((type != PaymentBank.XYKXF) && (type != PaymentBank.XYKCX) && 
				   (type != PaymentBank.XYKYE) && (type != PaymentBank.XYKCD) && (type != PaymentBank.XYKTH) && (type != PaymentBank.XKQT1))
	            {
	                errmsg = "银联接口不支持该交易";
	  ...
	  public boolean XYKWriteRequest(int type, double money, String track1,String track2, String track3,String oldseqno, String oldauthno,String olddate, Vector memo)
	  {
		  try
		  {
              ...
              else
              {
			   ...
			   String cmd = strtypecode + strje + strseqno + strsyjh + strsyyh + stroldterm +
