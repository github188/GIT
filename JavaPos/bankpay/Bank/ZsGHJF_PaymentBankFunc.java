...
public class ZsGHJF_PaymentBankFunc extends PaymentBankFunc
{
	String path = "c:\\ICBC";
	...
	public String XYKWriteRequest(int type, double money, String track1, String track2, String track3, String oldseqno, String oldauthno, String olddate, Vector memo)
	{
		...
		try
		{
			...
			switch (type)
			{
				case PaymentBank.XYKXF: // 积分消费
					type1 = "89";
					FuncID = "3004";// 分行特色脚本ID号
					PreInput = Convert.increaseChar("AMT1=" + Convert.increaseCharForward(jestr, '0', 12), ' ', 256);// 预输入项(就是金额)
					AddDatas = Convert.increaseChar(" ", ' ', 256);// 固定输入项
					break;
				case PaymentBank.XYKCX: // 当日撤销
					type1 = "04";
