...
public class Yfccb_PaymentBankFunc extends PaymentBankFunc
{
	String shh = null;
	...
	protected boolean WriteResultLog()
	{
		...
		{
			String filename = ConfigClass.BankPath + "\\softtpos.ini";
		...
		if (bld.retmsg == null || bld.retmsg.length() <= 0)
			bld.retmsg = "金卡调用完成";
	...
	public boolean XYKNeedPrintDoc()
	{
		...
		// 消费，消费撤销，重打签购单
		if ((type == PaymentBank.XYKXF) || (type == PaymentBank.XYKCX) || (type == PaymentBank.XYKTH) || (type == PaymentBank.XYKCD) || (type == PaymentBank.XYKJZ) || (type == PaymentBank.XYKYE))
		{
			return true;
		}
		else
	...
	public boolean checkBankSucceed()
	{
		...
		else
		{
			...
			// 加入解百特殊金卡工程断电保护
			String path = ConfigClass.BankPath + "\\answer.txt";
	...
	public String XYKgetRequest(int type, double money, String track1, String track2, String track3, String oldseqno, String oldauthno, String olddate, Vector memo)
	{
		try
		{
			...
			line = syjh + syyh + type1 + jestr + stroldterm;
	...
	public boolean XYKReadResult1(String result, int type)
	{
		try
		{
			...
			//00 1234567890123456789 0 000000000100 123456 123456789012 1234 1234567890 123456 12345678901234
			...
			bld.je = j;
			String trace = Convert.newSubString(line, 34, 40);
			bld.trace = Convert.toLong(trace);
