...
//创识分期付款接口
public class BjcsDmgFQ_PaymentBankFunc extends PaymentBankFunc
{
       ...
       else
       {
		...
		public boolean XYKWriteRequest(int type, double money, String track1,String track2, String track3,String oldseqno, String oldauthno,String olddate, Vector memo)
		{
			try
			{
		         ...
		         String gz = "";
		         if(saleBS!=null&&saleBS.saleGoods!=null&&saleBS.saleGoods.size()>0){
		        	 gz = ((SaleGoodsDef)saleBS.saleGoods.elementAt(0)).gz;
		         }
		         //	 根据不同的类型生成文本结构
		         switch (type)
		         {
		        	 case PaymentBank.XYKXF:
		        		 if (saleBS != null)
		        		 {
		        			 line 		= "W" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + gz +"||" + saleBS.saleHead.syjh + "|\0";
		        		 }
		        		 else
		        		 {
		        			 line 		= "W" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"|||" + GlobalInfo.syjDef.syjh +"|\0";
		        		 }
		        	 break;
		        	 case PaymentBank.XYKCX:
		        		 if (saleBS != null)
		        		 {
		        			 line = "5" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + gz + "|" + oldseqno + "|" + saleBS.saleHead.syjh + "|\0";
		        		 }
		        		 else
		        		 {
		        	 ...
		        	 case PaymentBank.XYKTH:
		        		 if (saleBS != null)
		        		 {
		        			 line = "4" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + gz + "|" + oldseqno + "|" + saleBS.saleHead.syjh + "|\0";
		        		 }
		        		 else
		        		 {
