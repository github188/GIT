...
public class NjysCDWQ_PaymentBankFunc extends PaymentBankFunc
{
		protected String bankpath = null;
	    ...
	    public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
	    {
	        try
	        {
	            ...
	            //更新：增加一个同样的金卡接口，并更新了主类
	            bankpath = getBankPath(paycode);	            
	            // 先删除上次交易数据文件
				...
				{
					CommonMethod.waitForExec(bankpath + "\\javaposbank.exe NJYS");
				}
				else
				{
	        ...
	        {   String line = null;
				...
				if(type == PaymentBank.XYKJZ ||type == PaymentBank.XYKQD){
					if(line.substring(0,1).equals("0")){
						...
						//new MessageBox("123失败");
						return false;
					}
				}
				
	            bld.retcode = line.substring(2,4);
	            ...
	            bld.cardno  = Convert.newSubString(line, 4, 23);
