 ...
 * 万千百货济南
 */
public class Bjcs2010_PaymentBankFunc extends PaymentBankFunc
{
...
//	        			 line = "0" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm +"||" + saleBS.saleHead.syjh + "|\0";
	        			 line = "0" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|" + saleBS.saleHead.fphm +"||" + ConfigClass.CashRegisterCode + "|\0";
	        		 }
	        		 else
	        		 {
//	        			 line = "0" + "|" + jestr + "||||" + GlobalInfo.syjDef.syjh +"|\0";
	        			 line = "0" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|||" + ConfigClass.CashRegisterCode +"|\0";
	        		 }
	        	 break;
...
//	        			 line = "5" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm + "|" + oldseqno + "|" + saleBS.saleHead.syjh + "|\0";
	        			 line = "5" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|" + saleBS.saleHead.fphm + "||" + ConfigClass.CashRegisterCode + "|\0";
	        		 }
	        		 else
	        		 {
//	        			 line = "5" + "|" + jestr + "||||" + GlobalInfo.syjDef.syjh + "|\0";
	        			 line = "5" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|||" + ConfigClass.CashRegisterCode + "|\0";
	        		 }
	        	 break;
...
//	        			 line = "4" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm + "|" + oldseqno + "|" + saleBS.saleHead.syjh + "|\0";
	        			 line = "4" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|" + saleBS.saleHead.fphm + "||" + ConfigClass.CashRegisterCode + "|\0";
	        		 }
	        		 else
	        		 {
//	        			 line = "4" + "|" + jestr + "||||" + GlobalInfo.syjDef.syjh + "|\0";
	        			 line = "4" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|||" + ConfigClass.CashRegisterCode + "|\0";
	        		 }
	        	 break;
	        	 ...
	        	 case PaymentBank.XKQT2:
	        		 line = "Z||" + GlobalInfo.posLogin.gh + "||| "+ GlobalInfo.syjDef.syjh + "|\0";
	        	 break;	 
	         }
	...
	public boolean XYKReadResult()
	{
       ...
       try
       {
           ...
           if (result.length > 9 && result[9] != null && !result[9].equals("") && result[9].length() < 5)
           {
        	   bld.bankinfo = result[9];
