 ...
 * 北京亚大中国银行(山东银座)
 */
public class Bjyd2_PaymentBankFunc extends PaymentBankFunc
{
	 ...
	 public boolean XYKReadResult()
	 {
        ...
        try
        {
            ...
            if(!bld.retcode.equals("00")){
            	...
            	bld.bankinfo = ManipulateByte.getString(ManipulateByte.getStringBytes(newLine,44,54));
            	bld.cardno = ManipulateByte.getString(ManipulateByte.getStringBytes(newLine,58,74));
