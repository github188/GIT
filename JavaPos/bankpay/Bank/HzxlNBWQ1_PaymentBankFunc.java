 ...
 *
 */
public class HzxlNBWQ1_PaymentBankFunc extends PaymentBankFunc
{
	...
	public boolean XYKExecute(int type, double money, String track1, String track2, String track3, String oldseqno, String oldauthno, String olddate, Vector memo)
	{
		try
		{
			if ((type != PaymentBank.XYKXF) && (type != PaymentBank.XYKCX) && (type != PaymentBank.XYKYE) && (type != PaymentBank.XYKCD)
					&& (type != PaymentBank.XYKTH) && (type != PaymentBank.XKQT1) && (type != PaymentBank.XYKJZ)&& (type != PaymentBank.XKQT2))
			{
				errmsg = "银联接口不支持该交易";
			...
			if (bld.retbz != 'Y')
			{
				...
				{
					CommonMethod.waitForExec("C:\\JavaPos\\javaposbank.exe HZXL");
				}
				else
				{
