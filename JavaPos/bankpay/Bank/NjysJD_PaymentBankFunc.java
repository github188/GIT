...
public class NjysJD_PaymentBankFunc extends PaymentBankFunc{
	 static{
		    System.loadLibrary("NJYS_SOFTDLL");
	 }
	 ...
	 public native String creditTransABC(String input,String bankpath);
	                              ...
	                              String oldauthno, String olddate, Vector memo)
	    {
	        try
	        {
	            ...
	            String request = null;
	            if ((request = creditTransABC(line,ConfigClass.BankPath)) == null)
                {
                    new MessageBox("金卡工程调用失败");
                    XYKSetError("XX","金卡工程调用失败");
                    return false;
                }
	                                      ...
	                                      String olddate, Vector memo)
	    {
	        try
	        {
	            ...
	            String paycode = "";
	            if (memo != null && memo.size() > 0) paycode = (String) memo.elementAt(0);
	    ...
	    public boolean XYKReadResult1(String result,int type)
	    {
	        try
	        {
	            ...
	            bld.je = j;
	            bld.oldtrace = Long.parseLong(Convert.newSubString(line, 34, 40));
	            bld.trace   = Long.parseLong(Convert.newSubString(line, 40, 46));
