 ...
 * 
 */
public class Jdd_PaymentBankFunc extends PaymentBankFunc
{
	...
	public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
	{
		try
		{
            ...
            if (bld.retbz != 'Y')
            {
                ...
                {
                	CommonMethod.waitForExec(ConfigClass.BankPath+"\\javaposbank.exe ICBCKPCLIENT3");
                }
                else
                {
