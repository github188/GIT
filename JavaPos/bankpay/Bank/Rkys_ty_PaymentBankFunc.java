...
//天洋购物（原接口名Rkys_PaymentBankFunc  改正了1。收银机号和收银员号换位  2.切纸）
public class Rkys_ty_PaymentBankFunc extends PaymentBankFunc
{
	String path = null;
	...
	public boolean XYKReadResult()
	{
		...
		try
        {
        	...
        	{
        		bld.retmsg = Convert.newSubString(result[1], 119, 151).trim();   //错误说明
        		return false;
        	}
