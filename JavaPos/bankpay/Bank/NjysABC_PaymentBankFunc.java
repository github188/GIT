...
//彭州置信
public class NjysABC_PaymentBankFunc extends PaymentBankFunc
{
	 String shh = null;
	 String zdh = null;
...
*/
	                                      ...
	                                      String olddate, Vector memo)
	    {
	        try
	        {
	            ...
	            Vector v = new Vector();
	            v.add(new String[]{"人民币卡"});
	            v.add(new String[]{" 外 卡"});
	        	int choice = new MutiSelectForm().open("请选择卡类型", new String[]{"说明"}, new int[]{100}, v);
	        	String cardtype = "0";
	        	if (choice <=0)
	        	{
	        ...
	        try
	        {
	            ...
	            for (int i = 0; i < 1; i++)
	            {
	                ...
	                try
	                {
	                    ...
	                    while ((line = br.readLine()) != null)
	                    {
	                        if (line.trim().equalsIgnoreCase("CUTPAPER"))
	                        {
	                           new MessageBox("请手工撕下签购单");
	                           continue;
	                        }
