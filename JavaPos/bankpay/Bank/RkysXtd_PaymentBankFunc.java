...
//沈阳群升新天地
public class RkysXtd_PaymentBankFunc extends PaymentBankFunc
{
	...
	public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
	{
		try
		{
            ...
            if (PathFile.fileExist(ConfigClass.BankPath + "\\data\\toprint.txt"))
            {
                PathFile.deletePath(ConfigClass.BankPath + "\\data\\toprint.txt");
            }
            ...
            if (bld.retbz != 'Y')
            {
                ...
                {
                	CommonMethod.waitForExec(ConfigClass.BankPath + "\\javaposbank.exe RKYS", "javaposbank");
                }
                else
                {
	...
	public boolean XYKReadResult()
	{
		...
		try
        {
            ...
            int type = Integer.parseInt(bld.type.trim());
            bld.retcode     = result[1].substring(0,2);
            if(type == PaymentBank.XYKQD ||type == PaymentBank.XYKYE||type == PaymentBank.XYKJZ||type == PaymentBank.XYKCD){
            ...
            }else if (result.length >= 2 && (type != PaymentBank.XYKQD||type != PaymentBank.XYKJZ))
            {
	...
	public void XYKPrintDoc()
	{
		...
		try
		{
			...
			if (!PathFile.fileExist(ConfigClass.BankPath + "\\data\\toprint.txt"))
            {	
				if (type == PaymentBank.XYKQD) return ;
            ...
            {
                printName = ConfigClass.BankPath + "\\data\\toprint.txt";
            }
