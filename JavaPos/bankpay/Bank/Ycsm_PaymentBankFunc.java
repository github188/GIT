...
public class Ycsm_PaymentBankFunc extends PaymentBankFunc{
	    String path = null;
		public String[] getFuncItem()
	    {
	        ...
	        func[7] = "[" + PaymentBank.XKQT3 + "]" + "重打任意笔签购单";
			...
			try
	        {
	            ...
	            if (result.length >= 2)
	            {
	            	...
	            	if(type == PaymentBank.XYKXF || type == PaymentBank.XYKCX ||  type == PaymentBank.XYKTH )
	            	{
	                	...
	                	bld.trace = Integer.parseInt(Convert.newSubString(result[1], 30, 36));   //流水号6
	                	bld.je = ManipulatePrecision.doubleConvert(ManipulatePrecision.div(Double.parseDouble(Convert.newSubString(result[1], 36, 48)),100),2,1);   //交易金额		
	            	}  	
