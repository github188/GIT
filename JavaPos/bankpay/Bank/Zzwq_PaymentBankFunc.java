...
public class Zzwq_PaymentBankFunc extends PaymentBankFunc 
{
	...
	public String[] getFuncItem() {
		...
		func[8] = "[" + PaymentBank.XYKJZ + "]" + "交易结账";
		func[9] = "[" + PaymentBank.XKQT3 + "]" + "分期付款";
		func[10] = "[" + PaymentBank.XKQT4 + "]" + "积分查询";
		func[11] = "[" + PaymentBank.XKQT5 + "]" + "积分消费";
		func[12] = "[" + PaymentBank.XKQT6 + "]" + "联合促销消费";
		func[13] = "[" + PaymentBank.XKQT7 + "]" + "联合促销消费分期";
	...
	public boolean getFuncLabel(int type, String[] grpLabelStr) {
		...
		case PaymentBank.XYKJZ: // 结算
			...
			grpLabelStr[4] = "交易结算";
			break;
		case PaymentBank.XKQT3: // 分期付款
			grpLabelStr[0] = null;
			grpLabelStr[1] = null;
			grpLabelStr[2] = null;
			grpLabelStr[3] = null;
			grpLabelStr[4] = "交易金额";
		case PaymentBank.XKQT4: // 积分查询
			grpLabelStr[0] = null;
			grpLabelStr[1] = null;
			grpLabelStr[2] = null;
			grpLabelStr[3] = null;
			grpLabelStr[4] = "积分查询";
		case PaymentBank.XKQT5: // 积分消费
			grpLabelStr[0] = null;
			grpLabelStr[1] = null;
			grpLabelStr[2] = null;
			grpLabelStr[3] = null;
			grpLabelStr[4] = "积分消费";
		case PaymentBank.XKQT6: // 联合促销消费
			grpLabelStr[0] = null;
			grpLabelStr[1] = null;
			grpLabelStr[2] = null;
			grpLabelStr[3] = null;
			grpLabelStr[4] = "联合促销消费";
		case PaymentBank.XKQT7: // 联合促销消费分期
			grpLabelStr[0] = null;
			grpLabelStr[1] = null;
			grpLabelStr[2] = null;
			grpLabelStr[3] = null;
			grpLabelStr[4] = "联合促销消费分期";
		}
	...
	public boolean XYKExecute(int type, double money, String track1,
		...
		try {
			if ((type != PaymentBank.XYKJZ) && (type != PaymentBank.XYKXF)
			...
			if (bld.retbz != 'Y') {
				...
				if (PathFile.fileExist("c:\\JavaPOS\\javaposbank.exe")) {
					CommonMethod.waitForExec(
							"c:\\JavaPOS\\javaposbank.exe BJCS",
							"javaposbank.exe");
				} else {
	...
	public boolean XYKWriteRequest(int type, double money, String track1,
		...
		try {
			...
			case PaymentBank.XYKXF:
				if (saleBS != null) {
					line = "0" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|"
							+ saleBS.saleHead.fphm + "||"
							+ saleBS.saleHead.syjh + "|\0";
				} else {
					line = "0" + "|" + jestr + "|" + GlobalInfo.syjStatus.syyh
							+ "|" + GlobalInfo.syjStatus.fphm + "||"
							+ GlobalInfo.syjDef.syjh + "|\0";
				}
				break;
			case PaymentBank.XYKCX:
				if (saleBS != null) {
					line = "5" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|"
							+ saleBS.saleHead.fphm + "|" + oldseqno + "|"
							+ saleBS.saleHead.syjh + "|\0";
				} else {
					line = "5" + "|" + jestr + "|" + GlobalInfo.syjStatus.syyh
							+ "|" + GlobalInfo.syjStatus.fphm + "|" + oldseqno
							+ "|" + GlobalInfo.syjDef.syjh + "|\0";
				}
				break;
			case PaymentBank.XYKTH:
				if (saleBS != null) {
					line = "4" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|"
							+ saleBS.saleHead.fphm + "|" + oldseqno + "|"
							+ saleBS.saleHead.syjh + "|\0";
				} else {
					line = "4" + "|" + jestr + "|" + GlobalInfo.syjStatus.syyh
							+ "|" + GlobalInfo.syjStatus.fphm + "|" + oldseqno
							+ "|" + GlobalInfo.syjDef.syjh + "|\0";
				}
				break;
			...
			case PaymentBank.XKQT1:
				line = "8||||" + oldseqno + "|" + GlobalInfo.syjDef.syjh
						+ "|\0";
				break;
			case PaymentBank.XKQT2:
				line = "Z||" + GlobalInfo.syjStatus.syyh + "||| "
						+ GlobalInfo.syjDef.syjh + "|\0";
				break;
			case PaymentBank.XYKJZ:
				// line = "9||||| "+ GlobalInfo.syjDef.syjh + "|\0";
				line = "9||" + GlobalInfo.syjStatus.syyh + "||| "
						+ GlobalInfo.syjDef.syjh + "|\0";
				//	        		 
				break;
			case PaymentBank.XKQT3:
				line = "W|" + jestr + "|||| " + GlobalInfo.syjDef.syjh + "|\0";
				break;
			case PaymentBank.XKQT4:
				line = "X||||| " + GlobalInfo.syjDef.syjh + "|\0";
				break;
			case PaymentBank.XKQT5:
				line = "J||||| " + GlobalInfo.syjDef.syjh + "|\0";
				break;
			case PaymentBank.XKQT6:
				line = "B|" + jestr + "|" + GlobalInfo.syjStatus.syyh + "|"
						+ GlobalInfo.syjStatus.fphm + "||"
						+ GlobalInfo.syjDef.syjh + "|\0";
				break;
			case PaymentBank.XKQT7:
				line = "O|" + jestr + "|" + GlobalInfo.syjStatus.syyh + "|"
						+ GlobalInfo.syjStatus.fphm + "||"
						+ GlobalInfo.syjDef.syjh + "|\0";
				break;
			}
	...
	public void XYKPrintDoc() {
		...
		try {
			...
			if ((type == PaymentBank.XYKXF || type == PaymentBank.XYKCX
					...
					|| type == PaymentBank.XKQT1 || type == PaymentBank.XKQT3
					|| type == PaymentBank.XKQT5 || type == PaymentBank.XKQT6 || type == PaymentBank.XKQT7)) {
