...
//银河读取会员
public class KgABC1_PaymentBankFunc extends PaymentBankFunc
{
	...
	public String[] getFuncItem()
	{
		...
		func[9] = "[" + PaymentBank.XKQT3+ "]" + "读取会员卡";
...
//				saleBS = (SaleBS) memo.elementAt(2);
			...
			{// 宽广超市要求能够通过菜单进行银联消费
				...
				case PaymentBank.XKQT3:
					line = "s||||| " + GlobalInfo.syjDef.syjh + "|\0";
					break;
