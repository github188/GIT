...
public class Wxwxc1_PaymentBankFunc extends PaymentBankFunc{
	    String path = null;
...
//	                	bld.memo = line.substring(95,96);//优惠标识
//	                	
//	                	bld.allotje = ManipulatePrecision.doubleConvert(ManipulatePrecision.div(Double.parseDouble(line.substring(96,108) ),100),2,1); //刷卡金额(实付金额)
//	                	
//	                	bld.kye = ManipulatePrecision.doubleConvert(ManipulatePrecision.div(Double.parseDouble(line.substring(108,120) ),100),2,1); //优惠/积分金额（银行支付）
	            	}  	
