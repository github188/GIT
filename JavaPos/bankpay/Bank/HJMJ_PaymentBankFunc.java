...
public class HJMJ_PaymentBankFunc extends PaymentBankFunc{
...
//				
	            ...
	            {
	            	CommonMethod.waitForExec(ConfigClass.BankPath+"\\javaposbank.exe PosAdapter","javaposbank");
	            }
	            else
	            {
...
//		            	bld.bankinfo = result[3];  //商户名称(此字段返回值长度太长，数据库报错，所以不记录)
		...
		public void XYKPrintDoc()
		{
			...
			ProgressBox pb = null;
			String name =ConfigClass.BankPath + "\\print.txt";
			try
			{
