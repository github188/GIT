...
//万千宁德店  （哈尔滨奥威斯 沿用该接口）
public class YlswNd_PaymentBankFunc extends PaymentBankFunc
{
                                   ...
                                   String olddate, Vector memo)
    {
        ...
        if (PathFile.fileExist("c:\\gmc\\GMC.exe"))
        {
            ...
            {
            	PathFile.copyPath("c:\\gmc\\receipt.txt","c:\\gmc\\Lastreceipt.txt");
    ...
    public boolean XYKReadResult(int type)
    {
        ...
        try
        {
            ...
            if (type == PaymentBank.XYKJZ) return true;
            //金额
