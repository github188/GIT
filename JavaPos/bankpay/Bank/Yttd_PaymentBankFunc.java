...
//永泰泰豆消费
public class Yttd_PaymentBankFunc extends PaymentBankFunc {
	...
	public String[] getFuncItem() {
		...
		func[0] = "[" + PaymentBank.XYKXF + "]" + "泰豆消费";
		func[1] = "[" + PaymentBank.XYKCX + "]" + "泰豆撤销";
		func[2] = "[" + PaymentBank.XYKTH + "]" + "泰豆退货";
		func[3] = "[" + PaymentBank.XYKCD + "]" + "泰豆退货撤销";
		return func;
	}
