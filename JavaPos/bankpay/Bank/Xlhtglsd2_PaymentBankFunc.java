...
//宁夏工行双宝超市MIS项目接口，调用动态库（模块名：XLHTGLSD；动态库(dll文件）：KeeperClient.dll；函数：int __stdcall misposTrans(void* input, void* output)；）
public class Xlhtglsd2_PaymentBankFunc extends PaymentBankFunc
{
