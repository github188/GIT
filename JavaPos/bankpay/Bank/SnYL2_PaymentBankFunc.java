...
/**
 * 深圳瑞柏
 * 调用动态库（模块名：SNYL；动态库(dll文件）：posmis.dll ；函数：Int DoTrans(REQ_MSG_NULL *requestMsg, RSP_MSG_NULL *responseMsg, char strParamFileName);）
 */
public class SnYL2_PaymentBankFunc extends PaymentBankFunc
{
	...
	public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
	{
		try
		{
            ...
            {
                PathFile.deletePath(getbankfunc() + "trans.rpt");
                
                if (PathFile.fileExist(getbankfunc() + "trans.rpt"))
                {
            		errmsg = "签购单打印文件trans.rpt没有删除,请重试";
            		XYKSetError("XX",errmsg);
            		new MessageBox(errmsg);
            		return false;   	
                }
	 ...
	 public boolean XYKWriteRequest(int type, double money, String track1,String track2, String track3,String oldseqno, String oldauthno,String olddate, Vector memo)
	 {
		 try
	     {
			...
			if(type == PaymentBank.XYKCD || type == PaymentBank.XKQT1){
				
				qt = Convert.increaseChar("10", 100); //第一个字节为1表示打印最后一笔、打印任意一笔  ；    第二个字节为0表示建行指令，为1表示储值卡等其他指令
				
			}else{
				
				qt = Convert.increaseChar(" 0", 100);
			}
	         ...
	         switch (type)
	         {
	         	...
	         	case PaymentBank.XYKYE:
	         		type1 = "03";	
	         	break;
	         	case PaymentBank.XYKCD:    //重打上笔
	         		type1 = "A0";	
	         	break;	
	         	case PaymentBank.XKQT1:    //重打任意笔
	         		type1 = "A1";	
	         	break;	
	        	case PaymentBank.XKQT2:    //QPBOC 查询余额
	         		type1 = "30";	
	         	break;	
	        	case PaymentBank.XKQT3:    //EMV 参数下载
	         		type1 = "91";	
	         	break;	
	        	case PaymentBank.XKQT4:    //公钥下载
	         		type1 = "92";	
