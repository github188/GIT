...
public class HfwdgcNh_PaymentBankFunc extends PaymentBankFunc
{
	 String shh = null;
	 String zdh = null;
	    ...
	    public String[] getFuncItem()
	    {
	        ...
	        func[6] = "[" + PaymentBank.XKQT1 + "]" + "其他";
	        func[7] = "[" + PaymentBank.XKQT2 + "]" + "交易一览";
	                              ...
	                              String oldauthno, String olddate, Vector memo)
	    {
	        try
	        {
	            if ((type != PaymentBank.XKQT2) &&(type != PaymentBank.XKQT1) &&(type != PaymentBank.XYKCD) && (type != PaymentBank.XYKXF) && (type != PaymentBank.XYKCX) && (type != PaymentBank.XYKTH) &&
				...
				{
					CommonMethod.waitForExec("c:\\gmc\\javaposbank.exe NJYSMZDABC", "javaposbank.exe");
				}
				else
				{
	                                      ...
	                                      String olddate, Vector memo)
	    {
	        try
	        {
	            ...
	            if(type1=='P'){
	            	line = syjh+syyh+type1+jestr+Convert.increaseChar(oldseqno,' ', 6);
	            }else{
