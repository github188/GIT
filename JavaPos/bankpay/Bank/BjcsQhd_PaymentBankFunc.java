...
public class BjcsQhd_PaymentBankFunc extends PaymentBankFunc
{
	...
	public String[] getFuncItem()
	{
		...
		func[9] = "[" + PaymentBank.XKQT3 + "]" + "DCC转人民币交易";
	...
	public boolean getFuncLabel(int type, String[] grpLabelStr)
	{
		switch (type)
		{
			...
			case PaymentBank.XYKJZ: // 结算
				...
				grpLabelStr[4] = "交易结算";
				break;
			case PaymentBank.XKQT3: // DCC转人民币交易
				grpLabelStr[0] = "参 考 号";
				grpLabelStr[1] = null;
				grpLabelStr[2] = null;
				grpLabelStr[3] = null;
	...
	public boolean XYKExecute(int type, double money, String track1, String track2, String track3, String oldseqno, String oldauthno, String olddate, Vector memo)
	{
		try
		{
			if ((type != PaymentBank.XYKJZ) && (type != PaymentBank.XYKXF) && (type != PaymentBank.XYKCX) && (type != PaymentBank.XYKTH) && (type != PaymentBank.XYKQD) && (type != PaymentBank.XYKYE) && (type != PaymentBank.XYKCD) && (type != PaymentBank.XKQT1) && (type != PaymentBank.XKQT2) && (type != PaymentBank.XKQT3))
			{
				errmsg = "银联接口不支持该交易";
			...
			if (PathFile.fileExist("c:\\JavaPOS\\Settle.txt"))
			{
				PathFile.deletePath("c:\\JavaPOS\\Settle.tx");

				if (PathFile.fileExist("c:\\JavaPOS\\Settle.txt"))
				{
					errmsg = "银行结算文件Settle.txt无法删除,请重试";
					XYKSetError("XX", errmsg);
					new MessageBox(errmsg);
					return false;
				}
			...
			if (bld.retbz != 'Y')
			{
				...
				{
					CommonMethod.waitForExec("c:\\JavaPOS\\javaposbank.exe BJCS", "javaposbank.exe");
				}
				else
				{
		...
		try
		{
			...
			{// 宽广超市要求能够通过菜单进行银联消费
				case PaymentBank.XYKXF:
					...
					{
						line = "0" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|" + GlobalInfo.syjStatus.fphm + "||" + GlobalInfo.syjDef.syjh + "|\0";
					}
					break;
				case PaymentBank.XYKCX:
					...
					{
						line = "5" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|" + GlobalInfo.syjStatus.fphm + "|" + oldseqno + "|" + GlobalInfo.syjDef.syjh + "|\0";
					}
					break;
				case PaymentBank.XYKTH:
					...
					{
						line = "4" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|" + GlobalInfo.syjStatus.fphm + "|" + oldseqno + "|" + GlobalInfo.syjDef.syjh + "|\0";
					}
					break;
				...
				case PaymentBank.XKQT1:
					line = "8||" + GlobalInfo.posLogin.gh + "||" + oldseqno + "|" + GlobalInfo.syjDef.syjh + "|\0";
					break;
				...
				case PaymentBank.XKQT3:
					if (saleBS != null)
					{
						line = "C" + "|" + jestr + "|" + saleBS.saleHead.syyh + "|" + saleBS.saleHead.fphm + "|" + oldseqno + "|" + saleBS.saleHead.syjh + "|\0";
					}
					else
					{
						line = "C" + "|" + jestr + "|" + GlobalInfo.posLogin.gh + "|" + GlobalInfo.syjStatus.fphm + "|" + oldseqno + "|" + GlobalInfo.syjDef.syjh + "|\0";
					}
					break;
			}
		...
		try
		{
			...
			if (bld.retcode.equals("00"))
			{
				if (result.length > 2 && result[2] != null && !result[2].equals(""))
					bld.cardno = result[2].trim();
				if (result.length > 3 && result[3] != null && !result[3].equals(""))
