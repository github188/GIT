...
//安奇乐易  TC[16]参数长度更改为130
public class ICBCAqly_PaymentBankFunc extends ICBCKPC_PaymentBankFunc
{
	...
	public boolean XYKExecute(int type, double money, String track1, String track2, String track3, String oldseqno, String oldauthno, String olddate, Vector memo)
	{
		try
		{
			...
			if (PathFile.fileExist(ConfigClass.BankPath + "\\javaposbank.exe"))
			{
				...
				bld.type = type1;
				line = type1 + "," + cardno + "," + jestr + "," + Tip + "," + MisBatchNo + "," + MisTraceNo + "," + TransTime + ","
						+ Convert.increaseChar("", 8) + "," + ExpDate + "," + Track2 + "," + Track3 + "," + ReferNo + "," + AuthNo + retmsg;
