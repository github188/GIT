...
*江苏扬州银联：中亚糖酒(无界面模式)
*/
public class YlswZYTJ_PaymentBankFunc extends PaymentBankFunc
{	
...
//			bld.trace = Long.parseLong(newLine.substring(26, 32));
			bld.trace = Convert.toLong(newLine.substring(26, 32));
			// 金额
...
//			bld.authno = newLine.substring(123, 135);
			bld.authno = Convert.newSubString(newLine, 123, 135);
			// LRC
//			String LRC = newLine.substring(145, 148);
			String LRC = Convert.newSubString(newLine, 145, 148);
