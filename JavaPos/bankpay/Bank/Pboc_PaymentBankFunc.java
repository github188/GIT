...
//交通银行天津市分行MIS-POS收单系统PBOC2.0接口
public class Pboc_PaymentBankFunc extends PaymentBankFunc
...
{	
	...
	public boolean XYKwriteRequest(int type, double money, String track1, String track2, String track3, String oldseqno, String oldauthno, String olddate, Vector memo)
	{
		 try
		 {
	         ...
	         {
	         	case PaymentBank.XYKXF:				// 消费
	         		line = "01"+"|" + "30|"  + jestr + "|000000|000000000000|000000|00000000000000000000|00000000000000000000|00000000000000000000";
	         		break;
	         	case PaymentBank.XYKCX:				// 撤销	

	         		line = "01"+"|" + "40|"  + jestr + "|" + oldseqno + "|" + oldauthno + "|000000|00000000000000000000|00000000000000000000|00000000000000000000";
	         		break;
	         	case PaymentBank.XYKTH:				// 退货    		
	         		line = "01"+"|" + "60|"  + jestr + "|" + oldseqno + "|" + oldauthno + "|" + olddate + "|00000000000000000000|00000000000000000000|00000000000000000000";
		         	break;
	         	case PaymentBank.XYKQD:				// 签到
	         		line = "01"+"|" + "91" + "|000000000000|000000|000000000000|000000|00000000000000000000|00000000000000000000|00000000000000000000";
	         		break;
	         	case PaymentBank.XYKJZ:				// 结算
	         		line = "01"+"|" + "95" + "|000000000000|000000|000000000000|000000|00000000000000000000|00000000000000000000|00000000000000000000";
	         		break;
	         	case PaymentBank.XKQT1:				// 重打结算单
	         		line = "01"+"|" + "62" + "|000000000000|000000|000000000000|000000|00000000000000000000|00000000000000000000|00000000000000000000";
	         		break;
	         	case PaymentBank.XYKYE:				// 查询

	         		line = "01"+"|" + "80" + "|000000000000|000000|000000000000|000000|00000000000000000000|00000000000000000000|00000000000000000000";
	         		break;
	         	case PaymentBank.XYKCD:				// 重打上笔签购单

	         		line = "01"+"|" + "64|" + jestr + "|000000|000000000000|000000|00000000000000000000|00000000000000000000|00000000000000000000";
	         		break;
