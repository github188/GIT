...
public class NjysZY1_PaymentBankFunc extends PaymentBankFunc {
	String shh = null;
	...
	public String XYKgetRequest(int type, double money, String track1,
		...
		try {
			...
			line = syjh + syyh + type1 + jestr + "   001";
	...
	public boolean XYKReadResult1(String result, int type) {
		try {
			...
			bld.trace = Convert.toLong(Convert.newSubString(line, 34, 40));
			bld.bankinfo = Convert.newSubString(line, 40, 44);
			bld.memo1 = Convert.newSubString(line, 44, 47);
			return true;
		} catch (Exception ex) {
