...
public class Jxnx_PaymentBankFunc extends PaymentBankFunc
{
	String path = null;
...
//            	if(type == PaymentBank.XYKXF || type == PaymentBank.XYKCX ||  type == PaymentBank.XYKTH )
//            	{
//                	bld.cardno = result[3];   //卡号20
//                	bld.trace = Integer.parseInt(result[5]);   //流水号6
//                	bld.je = ManipulatePrecision.doubleConvert(ManipulatePrecision.div(Double.parseDouble(result[6]),100),2,1);   //交易金额		
//            	}  	
//            	if(bld.retcode != "00")
//            	{
//            		bld.retmsg = result[7];   //错误说明
//            	}            
//            	String lrc = result[8];   //交易数据校验码
//    			if(!lrc.equals(bld.crc))
//    			{
//    				errmsg = "返回效验码" + lrc + "同原效验码" + bld.crc + "不一致";
//    				XYKSetError("XX", errmsg);
