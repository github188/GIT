...
/**
 * 秋林国际购物中心，我们界面读取轨道信息 积分消费
 * @author Administrator
 *
 */
public class HzxlQlgjFqJf_PaymentBankFunc extends PaymentBankFunc
{
	  public String[] getFuncItem()
	  {
	       ...
	       func[1] = "[" + PaymentBank.XYKCX + "]" + "积分撤销";
	       func[2] = "[" + PaymentBank.XYKJZ + "]" + "当班结算";
	  ...
	  public boolean XYKExecute(int type, double money, String track1,String track2, String track3, String oldseqno,String oldauthno, String olddate, Vector memo)
	  {
		  try
	      {
			  if ((type != PaymentBank.XYKXF) && (type != PaymentBank.XYKCX) &&  (type != PaymentBank.XYKJZ)&& (type != PaymentBank.XYKYE) && (type != PaymentBank.XYKCD))
	            {
	                errmsg = "银联接口不支持该交易";
	  ...
	  public boolean XYKWriteRequest(int type, double money, String track1,String track2, String track3,String oldseqno, String oldauthno,String olddate, Vector memo)
	  {
		  try
		  {
              ...
              if(strtypecode.equals("17")){
            	  strseqno = Convert.increaseChar(oldseqno,6); 
              }
              else if(strtypecode.equals("12")){
            	  strseqno = Convert.increaseChar(oldseqno,6); 
              }else{
	  ...
	  public boolean XYKReadResult()
	  {
		  ...
		  {	  
			 ...
			 // bld.bankinfo = Convert.newSubString(line, 87,89) + XYKReadBankName(Convert.newSubString(line,87,89).trim());
			  bld.bankinfo = "积分消费";  //客户要求直接显示积分消费
			  errmsg = bld.retmsg;
