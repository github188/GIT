...
public class BjcsTjyt_PaymentBankFunc extends PaymentBankFunc
{
	...
	public boolean XYKWriteRequest(int type, double money, String track1,String track2, String track3,String oldseqno, String oldauthno,String olddate, Vector memo)
	{
		try
		{
	         ...
	         if (memo != null && memo.size() >=2 ) saleBS = (SaleBS)memo.elementAt(2);
	         ...
	         switch (type)
	         {
	        	 case PaymentBank.XYKXF:
	        		 ...
	        		 {
	        			 line 		= "0" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"|"+GlobalInfo.syjStatus.fphm+"||" + GlobalInfo.syjDef.syjh +"|\0";
	        		 }
	        	 break;
	        	 case PaymentBank.XYKCX:
	        		 ...
	        		 {
	        			 line = "5" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"|"+GlobalInfo.syjStatus.fphm+"|" + oldseqno + "|" + GlobalInfo.syjDef.syjh + "|\0";
	        		 }
	        	 ...
	        	 case PaymentBank.XYKTH:
	        		 ...
	        		 {
	        			 line = "4" + "|" + jestr + "|"+ GlobalInfo.syjStatus.syyh+"|"+GlobalInfo.syjStatus.fphm+"|" + oldseqno + "|" + GlobalInfo.syjDef.syjh + "|\0";
	        		 }
	        	 break;
