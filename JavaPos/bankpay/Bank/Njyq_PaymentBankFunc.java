...
//南京玉桥
public class Njyq_PaymentBankFunc extends PaymentBankFunc
{
...
//            }
	...
	{
		if (bld.memo.trim().equals("1") && bld.retcode.trim().equals("00"))
		{
			bld.retbz = 'Y';
		...
		try
        {
            ...
            if (result.length >= 2)
            {
            	...
            	if(type != PaymentBank.XYKYE){
            		bld.je	   		= Double.parseDouble(result[1].substring(2,14));
            		bld.cardno 		= result[1].substring(14,33);
                	bld.bankinfo 	= result[1].substring(99,119);
            	}
	...
	public void XYKPrintDoc()
	{
		...
		try
		{
            ...
            {
                printName = ConfigClass.BankPath + "\\toprint.txt";
            }
