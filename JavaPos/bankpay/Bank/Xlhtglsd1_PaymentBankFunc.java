...
//湛江工行丽湾名邸广场MIS接口（比Xlhtglsd多一个积分消费），调用动态库（模块名：XLHTGLSD；动态库(dll文件）：KeeperClient.dll；函数：int __stdcall misposTrans(void* input, void* output)；）
public class Xlhtglsd1_PaymentBankFunc extends PaymentBankFunc
{
