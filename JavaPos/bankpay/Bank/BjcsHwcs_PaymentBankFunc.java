...
//鄂州豪威城市广场百货  打印机无切纸功能 两联之间 消息框提示撕纸
public class BjcsHwcs_PaymentBankFunc extends Bjcs_PaymentBankFunc
{
		...
		try
		{
			if ((type != PaymentBank.XYKXF) && (type != PaymentBank.XYKCX) && 
				(type != PaymentBank.XYKTH) && (type != PaymentBank.XYKQD) && 
				 ...
				 (type != PaymentBank.XKQT1) && (type != PaymentBank.XKQT2)&& (type != PaymentBank.XYKJZ)) 
	            {
	                errmsg = "银联接口不支持该交易";
            ...
            if (bld.retbz != 'Y')
            {
                ...
                {
                	CommonMethod.waitForExec("c:\\JavaPOS\\javaposbank.exe BJCS");
                }
                else
                {
