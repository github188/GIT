 ...
 *
 */
public class SuNingPrintMode  extends SaleBillMode
{	
	...
	{
		String line = GlobalVar.ConfigPath + "//SuNingPrintMode.ini";
...
//	}
	...
	public void setHashMap(HashMap<String,String>maps)
	{
		map = maps;
	}
		...
		if (line == null)
		{
			switch (Integer.parseInt(item.code))
			{
				case SBM_text: // 文本
					...
					break;
				case 82://淘宝账号
				     if(null!=map.get("account_no")&&!"".equals(map.get("account_no")))
				     {
				    	 String buyer_id = map.get("account_no");
				...
				case 83://商户交易号
					if(null!=map.get("out_order_no")&&!"".equals(map.get("out_order_no")))
					{
						line = map.get("out_order_no");
					}
					else
					{
						line = "";
					...
					break;
				case 84://支付宝交易号
					if(null!=map.get("epp_order_no")&&!"".equals(map.get("epp_order_no")))
					{
						line = map.get("epp_order_no");
					}
					else
					{
						line = "";
					...
					break;
				case 86://支付宝金额
					if(0!=Double.parseDouble(map.get("total_fee")))
					{
						line =  Double.toString(ManipulatePrecision.doubleConvert(Double.parseDouble(map.get("total_fee")) / 100));
					}
					else
					{
						line = "";
					...
					break;
				case 85://其中使用的支付方式
					if(null!=map.get("pay_channel")&&!"".equals(map.get("pay_channel")))
					{
//						line = "";
//						String pay_channel = map.get("pay_channel");
...
//			new MessageBox(Language.apply("获取税控信息失败！"));
	...
	//打印签购单
	public boolean suNingPrint(HashMap<String,String>map,SaleHeadDef salehead,Vector saleGoods,Vector salePayment,String printFlag)
	{
		boolean flag = true;
		if(ReadTemplateFile()&&
			null!=map.get("out_order_no")&&
			!"".equals(map.get("out_order_no")))
		   {
