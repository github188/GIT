...
public class WxPayService {
	...
	// javaPos地址
	private String url = "http://127.0.0.1:8080/JAVAPAYSERVER/WxPayServlet";
	 ...
	 * @return
	 */
	public String getQRcode(String money) 
	{
		try 
		{
			return ailHttp.HttpPostData(url, money);
		} 
		catch (Exception e) 
		{
			e.printStackTrace();
			...
			String money,String url,String extend_params) 
	{
		try 
		{
			...
			System.out.println(sb.toString()+partnerKey.trim());
			String sign = getMD5.GetMD5Code(sb.toString() + partnerKey.trim());
	...
	{
		WxPayService ws = new WxPayService();
		System.out.println("111111+"+ws.getQRcode(""));
	}
