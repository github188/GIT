...
public class SHCardPayTransfer implements ICommand {
	...
	private SHCardPayServletCommand shCardPayServletCommand =
		new SHCardPayServletCommand();
	...
	private String pay(SHCardPayVO payVo, String host) {
		...
		try {
			...
			params[0] =
				"com.royalstone.pos.web.command.SHCardPayServletCommand";
			params[1] = payVo;
			...
			if (host != null && !host.equals("NoCardServer")) {
				...
				results = shCardPayServletCommand.excute(params);
